...
/* {LIST}.is_equal */
EIF_BOOLEAN F772_12450 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F321_9603(RTCV(arg1));
		if ((EIF_BOOLEAN)(F321_9603(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F808_12653(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
		...
		if (tb1) {
			tb1 = '\0';
			tr1 = F808_12642(Current);
			loc1 = tr1;
			if (EIF_TEST(loc1)) {
				tr1 = F808_12642(RTCV(arg1));
				loc2 = tr1;
				tb1 = EIF_TEST(loc2);
			}
			if (tb1) {
				...
				for (;;) {
					tb1 = '\01';
					if (!F772_12451(Current)) {
						tb1 = (EIF_BOOLEAN) !Result;
					}
					if (tb1) break;
					if (*(EIF_BOOLEAN *)(Current + O9209[dtype-238])) {
						ti8_1 = F808_12636(Current);
						ti8_2 = F808_12636(RTCV(arg1));
					...
					F808_12664(Current);
					F808_12664(RTCV(arg1));
				}
				F808_12667(Current, loc1);
				F808_12667(RTCV(arg1), loc2);
			} else {
			}
		} else {
			tb2 = '\0';
			tb3 = '\0';
			if (F321_9603(Current)) {
				tb4 = F321_9603(RTCV(arg1));
				tb3 = tb4;
			}
			if (tb3) {
...
/* {LIST}.after */
EIF_BOOLEAN F772_12451 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
/* {LIST}.before */
EIF_BOOLEAN F772_12452 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
