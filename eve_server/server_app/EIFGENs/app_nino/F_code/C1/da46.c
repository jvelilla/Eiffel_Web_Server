...
static EIF_REFERENCE F63_6462_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
EIF_REFERENCE F63_6462 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(214,F63_6462_body,(Current));
}

/* {DATE_TIME_TOOLS}.months_text */
static EIF_REFERENCE F63_6463_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
EIF_REFERENCE F63_6463 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(215,F63_6463_body,(Current));
}

/* {DATE_TIME_TOOLS}.date_default_format_string */

EIF_REFERENCE F63_6466 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (212,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}

/* {DATE_TIME_TOOLS}.time_default_format_string */

EIF_REFERENCE F63_6467 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (218,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}

/* {DATE_TIME_TOOLS}.default_format_string */

EIF_REFERENCE F63_6468 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (222,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
