...
/* {LINEAR}.has */
EIF_BOOLEAN F283_9729 (EIF_REFERENCE Current, EIF_INTEGER_8 arg1)
{
	GTCX
...
/* {LINEAR}.search */
void F283_9731 (EIF_REFERENCE Current, EIF_INTEGER_8 arg1)
{
	GTCX
	EIF_BOOLEAN tb1;
	EIF_BOOLEAN tb2;
	...
	if (*(EIF_BOOLEAN *)(Current + O9209[Dtype(Current)-238])) {
		for (;;) {
			tb1 = '\01';
			if (!F283_9735(Current)) {
				tb1 = (arg1 == F817_12636(Current));
			}
			if (tb1) break;
			F817_12664(Current);
		}
		...
		for (;;) {
			tb2 = '\01';
			if (!F283_9735(Current)) {
				tb2 = (EIF_BOOLEAN)(arg1 == F817_12636(Current));
			}
			if (tb2) break;
			F817_12664(Current);
		}
...
EIF_INTEGER_8 F283_9734 (EIF_REFERENCE Current)
{
	GTCX
	
	
	return (EIF_INTEGER_8) F817_12636(Current);
}

/* {LINEAR}.exhausted */
EIF_BOOLEAN F283_9735 (EIF_REFERENCE Current)
{
	GTCX
...
/* {LINEAR}.off */
EIF_BOOLEAN F283_9737 (EIF_REFERENCE Current)
{
	GTCX
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
...
EIF_REFERENCE F283_9744 (EIF_REFERENCE Current)
{
	GTCX
