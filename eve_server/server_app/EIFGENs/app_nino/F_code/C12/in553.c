...
void F654_12188 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
...
EIF_REAL_64 F654_12189 (EIF_REFERENCE Current)
{
	GTCX
	...
	Result = *(EIF_REAL_64 *)(eif_optimize_return = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R11343[Dtype(tr1)-696])(RTCV(tr1), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_1_)));
	RTLE;
	return Result;
}

/* {INDEXABLE_ITERATION_CURSOR}.new_cursor */
EIF_REFERENCE F654_12195 (EIF_REFERENCE Current)
{
	GTCX
	...
	F654_12208(RTCV(Result));
	RTLE;
	return Result;
}

/* {INDEXABLE_ITERATION_CURSOR}.after */
EIF_BOOLEAN F654_12201 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_BOOLEAN tb1;
	...
	RTGC;
	Result = '\01';
	if (!(EIF_BOOLEAN) !F654_12203(Current)) {
		tr1 = *(EIF_REFERENCE *)(Current);
...
EIF_BOOLEAN F654_12203 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE tr1 = NULL;
...
void F654_12208 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
void F654_12209 (EIF_REFERENCE Current)
{
	GTCX
	RTLD;
...
EIF_REFERENCE F654_12210 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F654_12211 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
