...
/* {TO_SPECIAL}.area */
EIF_REFERENCE F557_11156 (EIF_REFERENCE Current)
{
...
void F557_11157 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
...
void F557_11158 (EIF_REFERENCE Current, EIF_CHARACTER_32 arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	RTLD;
	...
	RTGC;
	tr1 = RTLNSP2(eif_non_attached_type(eif_final_id(Y10387,Y10387_gen_type,Dftype(Current),545)),0,arg2,sizeof(EIF_CHARACTER_32), EIF_TRUE);
	F965_18821(RTCV(tr1), arg1, arg2);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + O10387[Dtype(Current)-545]) = (EIF_REFERENCE) tr1;
	RTLE;
}
...
/* {TO_SPECIAL}.set_area */
void F557_11163 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
