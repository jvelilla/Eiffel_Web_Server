...
/* {LIST}.is_equal */
EIF_BOOLEAN F777_12450 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F326_9603(RTCV(arg1));
		if ((EIF_BOOLEAN)(F326_9603(Current) == tb2)) {
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (*(EIF_BOOLEAN *)(Current + O9209[dtype-238])) {
						tu1_1 = *(EIF_NATURAL_8 *)(eif_optimize_return = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R9242[dtype-459])(Current));
						tu1_2 = *(EIF_NATURAL_8 *)(eif_optimize_return = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R9242[Dtype(arg1)-459])(RTCV(arg1)));
...
/* {LIST}.after */
EIF_BOOLEAN F777_12451 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
/* {LIST}.before */
EIF_BOOLEAN F777_12452 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
