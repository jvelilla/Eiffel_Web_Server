...
extern EIF_TYPED_VALUE F821_12250(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F821_12251(EIF_REFERENCE);
extern EIF_TYPED_VALUE F821_12252(EIF_REFERENCE);
extern void F821_22690(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F821_12250 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 820, Current, 2, 1, 6687);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(820, Current, 6687);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu1_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9218, "item", arg1))(arg1)).it_n1);
...
EIF_TYPED_VALUE F821_12251 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 820, Current, 0, 0, 6688);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(820, Current, 6688);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F821_12252 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 820, Current, 0, 0, 6689);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(820, Current, 6689);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F821_22690 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 820, Current, 0, 22689);
	RTSA(dtype);
	RTME(dtype, 0);
