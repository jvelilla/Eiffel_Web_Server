...
extern EIF_TYPED_VALUE F799_9603(EIF_REFERENCE);
extern EIF_TYPED_VALUE F799_9604(EIF_REFERENCE);
extern EIF_TYPED_VALUE F799_9605(EIF_REFERENCE);
extern void F799_9606(EIF_REFERENCE);
extern void F799_9607(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F799_9603 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 798, Current, 0, 0, 2790);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(798, Current, 2790);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F799_9604 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F799_9605 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 798, Current, 0, 0, 2792);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(798, Current, 2792);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F799_9606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 798, Current, 0, 0, 2793);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(798, Current, 2793);
	RTIV(Current, RTAL);
...
void F799_9607 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 798, Current, 0, 0, 2794);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(798, Current, 2794);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
