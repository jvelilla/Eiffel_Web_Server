...
extern EIF_TYPED_VALUE F820_9632(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F820_9635(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F820_9637(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F820_9632 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 819, Current, 0, 1, 3002);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(819, Current, 3002);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	
	uc1 = arg1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9220, Dtype(Current)))(Current, uc1x)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {COLLECTION}.fill */
void F820_9635 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 819, Current, 1, 1, 3003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(819, Current, 3003);
	if (arg1) {
		{
			...
			RTCC(arg1, 819, l_feature_name, 1, typres0);
		}
	}
	RTIV(Current, RTAL);
...
void F820_9637 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 819, Current, 0, 1, 3004);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(819, Current, 3004);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
