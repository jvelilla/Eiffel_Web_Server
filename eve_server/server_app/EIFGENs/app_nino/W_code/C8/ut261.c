...
extern EIF_TYPED_VALUE F261_11504(EIF_REFERENCE);
...
EIF_TYPED_VALUE F261_11504 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 260, Current, 0, 0, 4365);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(260, Current, 4365);
	RTIV(Current, RTAL);
	RTHOOK(1);
