...
static EIF_TYPE_INDEX gen_type0_242 [] = {454,241,0xFFFF};
...
static struct desc_info desc_242[] = {
	...
	{1, (BODY_INDEX)-1, 454, gen_type0_242},
...
void Init242(void)
{
	...
	IDSC(desc_242 + 34, 404, 241);
	IDSC(desc_242 + 36, 330, 241);
	IDSC(desc_242 + 37, 405, 241);
}
