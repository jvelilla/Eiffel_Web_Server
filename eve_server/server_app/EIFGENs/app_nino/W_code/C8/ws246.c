...
extern EIF_TYPED_VALUE F246_11133(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F246_11133 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 245, Current, 0, 1, 4032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(245, Current, 4032);
	if (arg1) {
