...
extern EIF_TYPED_VALUE F236_11017(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F236_11017 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 235, Current, 1, 1, 3952);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(235, Current, 3952);
	if (arg1) {
		RTCC(arg1, 235, l_feature_name, 1, 346);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(5);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(15140, "left_adjust", Result))(Result);
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(15141, "right_adjust", Result))(Result);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(7);
	RTDBGLE;
