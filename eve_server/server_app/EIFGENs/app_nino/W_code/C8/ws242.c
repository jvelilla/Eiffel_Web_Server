...
extern EIF_TYPED_VALUE F242_11051(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F242_11051 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 241, Current, 0, 1, 3970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(241, Current, 3970);
	if (arg1) {
		RTCC(arg1, 241, l_feature_name, 1, 346);
	}
	RTIV(Current, RTAL);
