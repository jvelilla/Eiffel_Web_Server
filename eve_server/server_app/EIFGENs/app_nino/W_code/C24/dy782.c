...
extern EIF_TYPED_VALUE F782_12328(EIF_REFERENCE);
extern EIF_TYPED_VALUE F782_12329(EIF_REFERENCE);
extern void F782_12335(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F782_12338(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F782_12339(EIF_REFERENCE);
extern EIF_TYPED_VALUE F782_12340(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F782_12328 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 781, Current, 0, 0, 6705);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(781, Current, 6705);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F782_12329 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 781, Current, 0, 0, 6706);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(781, Current, 6706);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F782_12335 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 781, Current, 0, 1, 6707);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(781, Current, 6707);
	RTIV(Current, RTAL);
...
void F782_12338 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 781, Current, 0, 1, 6702);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(781, Current, 6702);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F782_12339 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 781, Current, 0, 0, 6703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(781, Current, 6703);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F782_12340 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 781, Current, 2, 1, 6704);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(781, Current, 6704);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
