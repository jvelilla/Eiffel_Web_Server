...
extern EIF_TYPED_VALUE F789_12506(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F789_12507(EIF_REFERENCE);
extern EIF_TYPED_VALUE F789_12508(EIF_REFERENCE);
extern void F789_22964(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F789_12506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 788, Current, 2, 1, 6961);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(788, Current, 6961);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tp2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9252, "item", arg1))(arg1)).it_p);
...
/* {LIST}.after */
EIF_TYPED_VALUE F789_12507 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 788, Current, 0, 0, 6962);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(788, Current, 6962);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F789_12508 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 788, Current, 0, 0, 6963);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(788, Current, 6963);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F789_22964 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 788, Current, 0, 22963);
	RTSA(dtype);
	RTME(dtype, 0);
