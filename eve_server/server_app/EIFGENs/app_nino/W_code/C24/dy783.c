...
extern EIF_TYPED_VALUE F783_12498(EIF_REFERENCE);
extern EIF_TYPED_VALUE F783_12499(EIF_REFERENCE);
extern void F783_12505(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F783_12508(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F783_12509(EIF_REFERENCE);
extern EIF_TYPED_VALUE F783_12510(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F783_12498 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 782, Current, 0, 0, 6894);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(782, Current, 6894);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F783_12499 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 782, Current, 0, 0, 6895);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(782, Current, 6895);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F783_12505 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 782, Current, 0, 1, 6896);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(782, Current, 6896);
	RTIV(Current, RTAL);
...
void F783_12508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 782, Current, 0, 1, 6897);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(782, Current, 6897);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F783_12509 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 782, Current, 0, 0, 6898);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(782, Current, 6898);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F783_12510 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 782, Current, 2, 1, 6899);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(782, Current, 6899);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		up1 = tp1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9244, "extend", Result))(Result, up1x);
		RTHOOK(9);
