...
extern void F761_9690(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F761_9691(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F761_9690 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 760, Current, 0, 1, 3071);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 3071);
	RTCC(arg1, 760, l_feature_name, 1, RTWCT(9252, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F761_9691 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 760, Current, 1, 1, 3072);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(760, Current, 3072);
	if (arg1) {
		{
...
body:;
	RTHOOK(3);
	RTDBGAL(Current, 1, 0xF80002F7, 0, 0); /* loc1 */
	...
	for (;;) {
		...
		if (!tb3) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9236, dtype))(Current)).it_b);
			tb2 = (EIF_BOOLEAN) !tb3;
		}
		if (tb2) break;
		RTHOOK(9);
