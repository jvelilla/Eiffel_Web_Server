...
extern EIF_TYPED_VALUE F759_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F759_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 758, Current, 0, 0, 5972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(758, Current, 5972);
	RTIV(Current, RTAL);
	RTHOOK(1);
