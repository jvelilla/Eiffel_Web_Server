...
extern EIF_TYPED_VALUE F767_13000(EIF_REFERENCE);
extern EIF_TYPED_VALUE F767_13001(EIF_REFERENCE);
extern void F767_13007(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F767_13010(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F767_13011(EIF_REFERENCE);
extern EIF_TYPED_VALUE F767_13012(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F767_13000 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 766, Current, 0, 0, 7317);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(766, Current, 7317);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F767_13001 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 766, Current, 0, 0, 7318);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(766, Current, 7318);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F767_13007 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 766, Current, 0, 1, 7319);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(766, Current, 7319);
	RTIV(Current, RTAL);
...
void F767_13010 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 766, Current, 0, 1, 7320);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(766, Current, 7320);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F767_13011 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 766, Current, 0, 0, 7321);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(766, Current, 7321);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F767_13012 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 766, Current, 2, 1, 7322);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(766, Current, 7322);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		up1 = tp1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9646, "extend", Result))(Result, up1x);
		RTHOOK(9);
