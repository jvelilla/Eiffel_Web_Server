...
extern EIF_TYPED_VALUE F787_9607(EIF_REFERENCE);
extern EIF_TYPED_VALUE F787_9608(EIF_REFERENCE);
extern EIF_TYPED_VALUE F787_9609(EIF_REFERENCE);
extern void F787_9610(EIF_REFERENCE);
extern void F787_9611(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F787_9607 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 786, Current, 0, 0, 2791);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(786, Current, 2791);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F787_9608 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F787_9609 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 786, Current, 0, 0, 2793);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(786, Current, 2793);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F787_9610 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 786, Current, 0, 0, 2789);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(786, Current, 2789);
	RTIV(Current, RTAL);
...
void F787_9611 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 786, Current, 0, 0, 2790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(786, Current, 2790);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
