...
extern EIF_TYPED_VALUE F771_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F771_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 770, Current, 0, 0, 5413);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(770, Current, 5413);
	RTIV(Current, RTAL);
	RTHOOK(1);
