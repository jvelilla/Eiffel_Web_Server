...
extern EIF_TYPED_VALUE F765_9598(EIF_REFERENCE);
extern void F765_22751(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F765_9598 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 764, Current, 0, 0, 2999);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(764, Current, 2999);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F765_22751 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 764, Current, 0, 22750);
	RTSA(dtype);
	RTME(dtype, 0);
