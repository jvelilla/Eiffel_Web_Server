...
extern EIF_TYPED_VALUE F781_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F781_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 780, Current, 0, 0, 5973);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(780, Current, 5973);
	RTIV(Current, RTAL);
	RTHOOK(1);
