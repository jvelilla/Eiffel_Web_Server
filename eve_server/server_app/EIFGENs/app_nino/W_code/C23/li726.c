...
extern EIF_TYPED_VALUE F726_12250(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F726_12251(EIF_REFERENCE);
extern EIF_TYPED_VALUE F726_12252(EIF_REFERENCE);
extern void F726_22690(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F726_12250 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 725, Current, 2, 1, 6679);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(725, Current, 6679);
	RTCC(arg1, 725, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9218, "item", arg1))(arg1)).it_c1);
...
/* {LIST}.after */
EIF_TYPED_VALUE F726_12251 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 725, Current, 0, 0, 6680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(725, Current, 6680);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F726_12252 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 725, Current, 0, 0, 6681);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(725, Current, 6681);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F726_22690 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 725, Current, 0, 22689);
	RTSA(dtype);
	RTME(dtype, 0);
