...
extern EIF_TYPED_VALUE F733_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F733_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 732, Current, 0, 0, 5531);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(732, Current, 5531);
	RTIV(Current, RTAL);
	RTHOOK(1);
