...
extern EIF_TYPED_VALUE F750_12328(EIF_REFERENCE);
extern EIF_TYPED_VALUE F750_12329(EIF_REFERENCE);
extern void F750_12335(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F750_12338(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F750_12339(EIF_REFERENCE);
extern EIF_TYPED_VALUE F750_12340(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F750_12328 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 749, Current, 0, 0, 6699);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(749, Current, 6699);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F750_12329 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 749, Current, 0, 0, 6700);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(749, Current, 6700);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F750_12335 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 749, Current, 0, 1, 6701);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(749, Current, 6701);
	RTIV(Current, RTAL);
...
void F750_12338 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 749, Current, 0, 1, 6696);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(749, Current, 6696);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F750_12339 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 749, Current, 0, 0, 6697);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(749, Current, 6697);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F750_12340 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 749, Current, 2, 1, 6698);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(749, Current, 6698);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		up1 = tp1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9193, "extend", Result))(Result, up1x);
		RTHOOK(9);
