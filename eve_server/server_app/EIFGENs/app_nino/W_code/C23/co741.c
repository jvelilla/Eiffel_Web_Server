...
extern EIF_TYPED_VALUE F741_9592(EIF_REFERENCE);
extern EIF_TYPED_VALUE F741_9593(EIF_REFERENCE);
extern EIF_TYPED_VALUE F741_9594(EIF_REFERENCE);
extern void F741_9595(EIF_REFERENCE);
extern void F741_9596(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F741_9592 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 740, Current, 0, 0, 2754);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(740, Current, 2754);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F741_9593 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F741_9594 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 740, Current, 0, 0, 2756);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(740, Current, 2756);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F741_9595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 740, Current, 0, 0, 2757);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(740, Current, 2757);
	RTIV(Current, RTAL);
...
void F741_9596 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 740, Current, 0, 0, 2758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(740, Current, 2758);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
