...
extern EIF_TYPED_VALUE F738_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F738_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 737, Current, 0, 0, 5346);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(737, Current, 5346);
	RTIV(Current, RTAL);
	RTHOOK(1);
