...
extern EIF_TYPED_VALUE F743_12513(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F743_12514(EIF_REFERENCE);
extern EIF_TYPED_VALUE F743_12515(EIF_REFERENCE);
extern void F743_22971(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F743_12513 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 742, Current, 2, 1, 6965);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(742, Current, 6965);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9256, "item", arg1))(arg1)).it_n4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F743_12514 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 742, Current, 0, 0, 6966);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(742, Current, 6966);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F743_12515 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 742, Current, 0, 0, 6967);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(742, Current, 6967);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F743_22971 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 742, Current, 0, 22970);
	RTSA(dtype);
	RTME(dtype, 0);
