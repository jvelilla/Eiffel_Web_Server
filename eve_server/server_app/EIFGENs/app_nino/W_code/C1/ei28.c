...
#define ur1 ur1x.it_r
	...
	if (arg1) {
		RTCC(arg1, 27, l_feature_name, 1, 359);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3952, 0xF80001AB, 0); /* json_object */
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3949, 0xF8000167, 0); /* warning_message */
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 27, Current, 26, 0, 448);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 3951, 0xF80001AA, 0); /* json_array */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3951, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3950, 0x10000000, 1); /* warning_count */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(3950, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	...
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
		...
		*(EIF_REFERENCE *)(Current + RTWA(3952, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
		...
		loc16 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3949, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTHOOK(98);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3952, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(98,1);
		ur1 = RTCCL(loc16);
