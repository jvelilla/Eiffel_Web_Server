...
extern void F3_22906(EIF_REFERENCE, int);
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 2, Current, 2, 1, 61);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F3_22906 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 2, Current, 0, 22905);
	RTSA(dtype);
	RTME(dtype, 0);
