...
extern void F31_3981(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F31_3982(EIF_REFERENCE);
extern EIF_TYPED_VALUE F31_3983(EIF_REFERENCE);
extern EIF_TYPED_VALUE F31_3984(EIF_REFERENCE);
extern EIF_TYPED_VALUE F31_3985(EIF_REFERENCE);
extern EIF_TYPED_VALUE F31_3986(EIF_REFERENCE);
extern void F31_3987(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F31_3988(EIF_REFERENCE);
...
void F31_3981 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 30, Current, 0, 2, 471);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg2) {
		RTCC(arg2, 30, l_feature_name, 2, 359);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(3983, dtype))(Current, ur1x, ur2x);
	RTHOOK(2);
...
EIF_TYPED_VALUE F31_3982 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F31_3983 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F31_3984 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F31_3987 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 30, Current, 0, 2, 477);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(30, Current, 477);
	if (arg1) {
		RTCC(arg1, 30, l_feature_name, 1, 359);
	}
	if (arg2) {
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 3978, 0xF8000167, 0); /* message */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(3978, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 3979, 0xF8000167, 0); /* class_name */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3979, dtype)) = (EIF_REFERENCE) RTCCL(arg2);
	...
	RTHOOK(6);
	RTDBGAA(Current, dtype, 3982, 0x10000000, 1); /* index */
	
	*(EIF_INTEGER_32 *)(Current + RTWA(3982, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5L);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
void F31_3988 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 30, Current, 4, 0, 478);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(30, Current, 478);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 3980, 0xF80001AA, 0); /* json_array */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3980, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	loc1 = *(EIF_INTEGER_32 *)(Current + RTWA(3982, dtype));
	for (;;) {
		RTHOOK(4);
		tb1 = '\01';
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3978, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		...
		RTHOOK(9);
		RTDBGAA(Current, dtype, 3981, 0xF8000167, 0); /* class_string */
		...
		*(EIF_REFERENCE *)(Current + RTWA(3981, dtype)) = (EIF_REFERENCE) RTCCL(tr2);
		...
		tr2 = RTMS_EX_H("*",1,42);
		ur1 = tr2;
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(15133, "has_substring", tr1))(tr1, ur1x)).it_b);
		if (tb3) {
			RTHOOK(11);
			ub1 = (EIF_BOOLEAN) 1;
			tr1 = RTLN(394);
			...
			RTNHOOK(11,1);
			ur1 = RTCCL(tr1);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(17311, "put_boolean", loc4))(loc4, ub1x, ur1x);
		} else {
			RTHOOK(12);
			ub1 = (EIF_BOOLEAN) 0;
			tr1 = RTLN(394);
