...
void F10_3728 (EIF_REFERENCE Current)
{
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(3733, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5000L);
	RTHOOK(5);
	RTDBGAA(Current, dtype, 3728, 0xF8000167, 0); /* document_root */
...
#define arg1 arg1x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 3729, 0xF8000167, 0); /* http_server_name */
...
#define arg1 arg1x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 3728, 0xF8000167, 0); /* document_root */
