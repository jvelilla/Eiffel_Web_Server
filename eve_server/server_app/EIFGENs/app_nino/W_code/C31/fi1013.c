...
extern EIF_TYPED_VALUE F1013_9582(EIF_REFERENCE);
extern void F1013_22657(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F1013_9582 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1012, Current, 0, 0, 2816);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1012, Current, 2816);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F1013_22657 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1012, Current, 0, 22656);
	RTSA(dtype);
	RTME(dtype, 0);
