...
extern EIF_TYPED_VALUE F1020_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1020_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1019, Current, 0, 0, 5419);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1019, Current, 5419);
	RTIV(Current, RTAL);
	RTHOOK(1);
