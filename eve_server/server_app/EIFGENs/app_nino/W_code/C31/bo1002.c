...
extern EIF_TYPED_VALUE F1002_9568(EIF_REFERENCE);
extern void F1002_22749(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F1002_9568 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1001, Current, 0, 0, 2826);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1001, Current, 2826);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F1002_22749 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1001, Current, 0, 22748);
	RTSA(dtype);
	RTME(dtype, 0);
