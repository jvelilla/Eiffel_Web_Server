...
extern EIF_TYPED_VALUE F1003_9574(EIF_REFERENCE);
extern void F1003_22809(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F1003_9574 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 2805);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1002, Current, 2805);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F1003_22809 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1002, Current, 0, 22808);
	RTSA(dtype);
	RTME(dtype, 0);
