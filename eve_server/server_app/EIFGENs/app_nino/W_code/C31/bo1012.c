...
extern void F1012_22658(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1012_9584 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1011, Current, 0, 0, 2846);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1011, Current, 2846);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F1012_22658 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1011, Current, 0, 22657);
	RTSA(dtype);
	RTME(dtype, 0);
