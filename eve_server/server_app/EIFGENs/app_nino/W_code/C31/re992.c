...
extern EIF_TYPED_VALUE F992_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F992_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 991, Current, 0, 0, 5978);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(991, Current, 5978);
	RTIV(Current, RTAL);
	RTHOOK(1);
