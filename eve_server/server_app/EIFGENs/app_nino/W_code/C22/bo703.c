...
extern EIF_TYPED_VALUE F703_9620(EIF_REFERENCE);
extern void F703_22936(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F703_9620 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 702, Current, 0, 0, 2864);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(702, Current, 2864);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F703_22936 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 702, Current, 0, 22935);
	RTSA(dtype);
	RTME(dtype, 0);
