...
extern EIF_TYPED_VALUE F699_9566(EIF_REFERENCE);
extern void F699_22748(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F699_9566 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 698, Current, 0, 0, 2782);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(698, Current, 2782);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F699_22748 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 698, Current, 0, 22747);
	RTSA(dtype);
	RTME(dtype, 0);
