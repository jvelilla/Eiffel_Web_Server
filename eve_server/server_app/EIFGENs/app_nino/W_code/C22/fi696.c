...
extern EIF_TYPED_VALUE F696_9574(EIF_REFERENCE);
extern void F696_22809(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F696_9574 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 695, Current, 0, 0, 2791);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(695, Current, 2791);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F696_22809 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 695, Current, 0, 22808);
	RTSA(dtype);
	RTME(dtype, 0);
