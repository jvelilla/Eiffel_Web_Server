...
extern void F693_12709(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F693_12710(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F693_12711(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F693_12712(EIF_REFERENCE);
extern EIF_TYPED_VALUE F693_12713(EIF_REFERENCE);
...
void F693_12709 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 692, Current, 0, 1, 7967);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 7967);
	RTCC(arg1, 692, l_feature_name, 1, RTWCT(9242, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11527, dtype))(Current, ur1x);
	RTHOOK(3);
...
/* {ARRAYED_STACK}.put */
void F693_12710 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 692, Current, 0, 1, 7963);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 7963);
	RTCC(arg1, 692, l_feature_name, 1, RTWCT(9242, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {ARRAYED_STACK}.force */
void F693_12711 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 692, Current, 0, 1, 7964);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 7964);
	RTCC(arg1, 692, l_feature_name, 1, RTWCT(9242, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F693_12712 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 692, Current, 0, 0, 7965);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 7965);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F693_12713 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 692, Current, 1, 0, 7966);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 7966);
	RTIV(Current, RTAL);
	RTHOOK(1);
