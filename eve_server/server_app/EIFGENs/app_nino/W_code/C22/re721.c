...
extern EIF_TYPED_VALUE F721_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F721_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 720, Current, 0, 0, 5412);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(720, Current, 5412);
	RTIV(Current, RTAL);
	RTHOOK(1);
