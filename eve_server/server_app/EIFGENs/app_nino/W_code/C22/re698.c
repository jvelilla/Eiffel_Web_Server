...
extern EIF_TYPED_VALUE F698_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F698_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 697, Current, 0, 0, 5530);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(697, Current, 5530);
	RTIV(Current, RTAL);
	RTHOOK(1);
