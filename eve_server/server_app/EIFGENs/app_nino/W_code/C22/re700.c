...
extern EIF_TYPED_VALUE F700_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F700_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 699, Current, 0, 0, 5411);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(699, Current, 5411);
	RTIV(Current, RTAL);
	RTHOOK(1);
