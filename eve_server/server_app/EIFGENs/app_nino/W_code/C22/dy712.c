...
extern EIF_TYPED_VALUE F712_12372(EIF_REFERENCE);
extern EIF_TYPED_VALUE F712_12373(EIF_REFERENCE);
extern void F712_12379(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F712_12382(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F712_12383(EIF_REFERENCE);
extern EIF_TYPED_VALUE F712_12384(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F712_12372 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 711, Current, 0, 0, 6756);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(711, Current, 6756);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F712_12373 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 711, Current, 0, 0, 6757);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(711, Current, 6757);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F712_12379 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 711, Current, 0, 1, 6758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(711, Current, 6758);
	RTIV(Current, RTAL);
...
void F712_12382 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 711, Current, 0, 1, 6759);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(711, Current, 6759);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F712_12383 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 711, Current, 0, 0, 6760);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(711, Current, 6760);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F712_12384 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 711, Current, 2, 1, 6761);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(711, Current, 6761);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		up1 = tp1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9201, "extend", Result))(Result, up1x);
		RTHOOK(9);
