...
extern EIF_TYPED_VALUE F706_12343(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F706_12344(EIF_REFERENCE);
extern EIF_TYPED_VALUE F706_12345(EIF_REFERENCE);
extern void F706_22783(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F706_12343 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 705, Current, 2, 1, 6768);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(705, Current, 6768);
	RTCC(arg1, 705, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						ti1_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9205, "item", arg1))(arg1)).it_i1);
...
/* {LIST}.after */
EIF_TYPED_VALUE F706_12344 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 705, Current, 0, 0, 6769);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(705, Current, 6769);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F706_12345 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 705, Current, 0, 0, 6770);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(705, Current, 6770);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F706_22783 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 705, Current, 0, 22782);
	RTSA(dtype);
	RTME(dtype, 0);
