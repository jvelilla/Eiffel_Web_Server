...
extern void F694_9679(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F694_9680(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F694_9679 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 693, Current, 0, 1, 3050);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(693, Current, 3050);
	RTCC(arg1, 693, l_feature_name, 1, RTWCT(9242, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F694_9680 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 693, Current, 1, 1, 3051);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(693, Current, 3051);
	if (arg1) {
		{
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(6);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9286, "item", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
