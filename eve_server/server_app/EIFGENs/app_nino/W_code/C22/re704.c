...
extern EIF_TYPED_VALUE F704_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F704_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 703, Current, 0, 0, 5971);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(703, Current, 5971);
	RTIV(Current, RTAL);
	RTHOOK(1);
