...
extern EIF_TYPED_VALUE F1029_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1029_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1028, Current, 0, 0, 5979);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1028, Current, 5979);
	RTIV(Current, RTAL);
	RTHOOK(1);
