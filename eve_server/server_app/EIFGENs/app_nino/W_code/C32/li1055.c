...
extern EIF_TYPED_VALUE F1055_13015(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1055_13016(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1055_13017(EIF_REFERENCE);
extern void F1055_23529(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F1055_13015 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1054, Current, 2, 1, 7424);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1054, Current, 7424);
	RTCC(arg1, 1054, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						ti1_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9658, "item", arg1))(arg1)).it_i1);
...
/* {LIST}.after */
EIF_TYPED_VALUE F1055_13016 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1054, Current, 0, 0, 7425);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1054, Current, 7425);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F1055_13017 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1054, Current, 0, 0, 7426);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1054, Current, 7426);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F1055_23529 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1054, Current, 0, 23528);
	RTSA(dtype);
	RTME(dtype, 0);
