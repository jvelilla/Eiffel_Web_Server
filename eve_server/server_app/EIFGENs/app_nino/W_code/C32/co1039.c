...
extern EIF_TYPED_VALUE F1039_9628(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1039_9631(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1039_9633(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1039_9628 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1038, Current, 0, 1, 3010);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1038, Current, 3010);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	
	ur4_1 = arg1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9216, Dtype(Current)))(Current, ur4_1x)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {COLLECTION}.fill */
void F1039_9631 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1038, Current, 1, 1, 3011);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1038, Current, 3011);
	if (arg1) {
		{
			...
			RTCC(arg1, 1038, l_feature_name, 1, typres0);
		}
	}
	RTIV(Current, RTAL);
...
void F1039_9633 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1038, Current, 0, 1, 3012);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1038, Current, 3012);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	for (;;) {
		...
		RTHOOK(3);
		ur4_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9242, dtype))(Current, ur4_1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
