...
extern EIF_TYPED_VALUE F1024_12308(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1024_12308 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1023, Current, 0, 0, 5545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1023, Current, 5545);
	RTIV(Current, RTAL);
	RTHOOK(1);
