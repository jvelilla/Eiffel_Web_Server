...
extern EIF_TYPED_VALUE F1028_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1028_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1027, Current, 0, 0, 5538);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1027, Current, 5538);
	RTIV(Current, RTAL);
	RTHOOK(1);
