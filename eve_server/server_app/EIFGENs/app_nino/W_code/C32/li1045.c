...
extern EIF_TYPED_VALUE F1045_12513(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1045_12514(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1045_12515(EIF_REFERENCE);
extern void F1045_22971(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F1045_12513 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1044, Current, 2, 1, 6993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1044, Current, 6993);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9256, "item", arg1))(arg1)).it_r4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F1045_12514 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1044, Current, 0, 0, 6994);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1044, Current, 6994);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F1045_12515 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1044, Current, 0, 0, 6995);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1044, Current, 6995);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F1045_22971 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1044, Current, 0, 22970);
	RTSA(dtype);
	RTME(dtype, 0);
