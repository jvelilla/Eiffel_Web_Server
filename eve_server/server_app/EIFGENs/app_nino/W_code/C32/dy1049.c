...
extern EIF_TYPED_VALUE F1049_12498(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1049_12499(EIF_REFERENCE);
extern void F1049_12505(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1049_12508(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1049_12509(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1049_12510(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1049_12498 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1048, Current, 0, 0, 6930);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1048, Current, 6930);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1049_12499 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1048, Current, 0, 0, 6931);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1048, Current, 6931);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F1049_12505 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1048, Current, 0, 1, 6932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1048, Current, 6932);
	RTIV(Current, RTAL);
...
void F1049_12508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1048, Current, 0, 1, 6933);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1048, Current, 6933);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F1049_12509 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1048, Current, 0, 0, 6934);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1048, Current, 6934);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F1049_12510 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1048, Current, 2, 1, 6935);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1048, Current, 6935);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ur4_1 = tr4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9244, "extend", Result))(Result, ur4_1x);
		RTHOOK(9);
