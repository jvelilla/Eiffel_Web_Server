...
extern EIF_TYPED_VALUE F1048_10350(EIF_REFERENCE);
extern void F1048_10353(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1048_23500(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F1048_10350 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1047, Current, 0, 0, 3762);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1047, Current, 3762);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F1048_10353 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1047, Current, 0, 1, 3763);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1047, Current, 3763);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9801, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	ui1_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9803, dtype))(Current, ui1_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F1048_23500 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1047, Current, 0, 23499);
	RTSA(dtype);
	RTME(dtype, 0);
