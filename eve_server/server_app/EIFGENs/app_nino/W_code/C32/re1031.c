...
extern EIF_TYPED_VALUE F1031_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1031_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1030, Current, 0, 0, 5353);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1030, Current, 5353);
	RTIV(Current, RTAL);
	RTHOOK(1);
