...
extern EIF_TYPED_VALUE F1039_9598(EIF_REFERENCE);
extern void F1039_22751(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F1039_9598 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1038, Current, 0, 0, 3011);
	RTSA(Dtype(Current));
	RTSC;
...
/* {ACTIVE}._invariant */
void F1039_22751 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1038, Current, 0, 22750);
	RTSA(dtype);
	RTME(dtype, 0);
