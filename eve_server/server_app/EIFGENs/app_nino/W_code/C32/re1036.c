...
extern void F1036_9575(EIF_REFERENCE);
extern void F1036_22750(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1035, Current, 0, 0, 2917);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1035, Current, 2917);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1036_9574 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1035, Current, 0, 0, 2918);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1035, Current, 2918);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1036_9575 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1035, Current, 0, 0, 2919);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1035, Current, 2919);
	RTIV(Current, RTAL);
...
void F1036_22750 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1035, Current, 0, 22749);
	RTSA(dtype);
	RTME(dtype, 0);
