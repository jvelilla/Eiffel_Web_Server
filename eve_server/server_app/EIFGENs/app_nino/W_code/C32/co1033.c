...
extern EIF_TYPED_VALUE F1033_9603(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1033_9604(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1033_9605(EIF_REFERENCE);
extern void F1033_9606(EIF_REFERENCE);
extern void F1033_9607(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F1033_9603 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1032, Current, 0, 0, 2810);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1032, Current, 2810);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1033_9604 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F1033_9605 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1032, Current, 0, 0, 2812);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1032, Current, 2812);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F1033_9606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1032, Current, 0, 0, 2813);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 2813);
	RTIV(Current, RTAL);
...
void F1033_9607 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1032, Current, 0, 0, 2814);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1032, Current, 2814);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
