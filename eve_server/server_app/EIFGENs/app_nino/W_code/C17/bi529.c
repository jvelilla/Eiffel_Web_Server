...
extern EIF_TYPED_VALUE F529_9866(EIF_REFERENCE);
extern void F529_9869(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F529_22755(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F529_9866 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 528, Current, 0, 0, 3300);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(528, Current, 3300);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F529_9869 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 528, Current, 0, 1, 3301);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(528, Current, 3301);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9348, dtype))(Current)).it_b);
...
/* {BILINEAR}._invariant */
void F529_22755 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 528, Current, 0, 22754);
	RTSA(dtype);
	RTME(dtype, 0);
