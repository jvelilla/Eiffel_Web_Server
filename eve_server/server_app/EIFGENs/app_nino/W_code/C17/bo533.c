...
extern EIF_TYPED_VALUE F533_9620(EIF_REFERENCE);
extern void F533_22936(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F533_9620 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 532, Current, 0, 0, 2854);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(532, Current, 2854);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F533_22936 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 532, Current, 0, 22935);
	RTSA(dtype);
	RTME(dtype, 0);
