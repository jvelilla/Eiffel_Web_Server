...
extern EIF_TYPED_VALUE F542_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F542_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 541, Current, 0, 0, 5341);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(541, Current, 5341);
	RTIV(Current, RTAL);
	RTHOOK(1);
