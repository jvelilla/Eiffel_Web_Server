...
extern EIF_TYPED_VALUE F540_10052(EIF_REFERENCE);
extern void F540_23494(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F540_10052 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 539, Current, 0, 0, 3228);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(539, Current, 3228);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F540_23494 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 539, Current, 0, 23493);
	RTSA(dtype);
	RTME(dtype, 0);
