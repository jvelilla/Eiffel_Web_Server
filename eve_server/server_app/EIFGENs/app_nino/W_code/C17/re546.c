...
extern EIF_TYPED_VALUE F546_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F546_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 545, Current, 0, 0, 5407);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(545, Current, 5407);
	RTIV(Current, RTAL);
	RTHOOK(1);
