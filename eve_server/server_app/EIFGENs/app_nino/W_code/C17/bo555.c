...
extern EIF_TYPED_VALUE F555_9568(EIF_REFERENCE);
extern void F555_22749(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F555_9568 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 554, Current, 0, 0, 2804);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(554, Current, 2804);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F555_22749 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 554, Current, 0, 22748);
	RTSA(dtype);
	RTME(dtype, 0);
