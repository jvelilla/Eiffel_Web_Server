...
extern EIF_TYPED_VALUE F556_9566(EIF_REFERENCE);
extern void F556_22748(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F556_9566 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 555, Current, 0, 0, 2774);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(555, Current, 2774);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F556_22748 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 555, Current, 0, 22747);
	RTSA(dtype);
	RTME(dtype, 0);
