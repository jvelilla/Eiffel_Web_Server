...
extern EIF_TYPED_VALUE F554_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F554_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 553, Current, 0, 0, 5526);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(553, Current, 5526);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800022A, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {554,0,0xFFFF};
