...
extern EIF_TYPED_VALUE F559_9603(EIF_REFERENCE);
extern EIF_TYPED_VALUE F559_9604(EIF_REFERENCE);
extern EIF_TYPED_VALUE F559_9605(EIF_REFERENCE);
extern void F559_9606(EIF_REFERENCE);
extern void F559_9607(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F559_9603 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 558, Current, 0, 0, 2750);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(558, Current, 2750);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F559_9604 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F559_9605 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 558, Current, 0, 0, 2752);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(558, Current, 2752);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F559_9606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 558, Current, 0, 0, 2753);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(558, Current, 2753);
	RTIV(Current, RTAL);
...
void F559_9607 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 558, Current, 0, 0, 2754);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(558, Current, 2754);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
