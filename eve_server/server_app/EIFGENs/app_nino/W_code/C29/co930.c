...
extern EIF_TYPED_VALUE F930_9592(EIF_REFERENCE);
extern EIF_TYPED_VALUE F930_9593(EIF_REFERENCE);
extern EIF_TYPED_VALUE F930_9594(EIF_REFERENCE);
extern void F930_9595(EIF_REFERENCE);
extern void F930_9596(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F930_9592 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 929, Current, 0, 0, 2774);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(929, Current, 2774);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F930_9593 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F930_9594 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 929, Current, 0, 0, 2776);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(929, Current, 2776);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F930_9595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 929, Current, 0, 0, 2777);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(929, Current, 2777);
	RTIV(Current, RTAL);
...
void F930_9596 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 929, Current, 0, 0, 2778);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(929, Current, 2778);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
