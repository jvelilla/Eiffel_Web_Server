...
extern void F936_11479(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F936_11480(EIF_REFERENCE);
extern EIF_TYPED_VALUE F936_11481(EIF_REFERENCE);
extern EIF_TYPED_VALUE F936_11482(EIF_REFERENCE);
extern void F936_22829(EIF_REFERENCE, int);
...
void F936_11479 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 935, Current, 0, 3, 4394);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(935, Current, 4394);
	RTCC(arg1, 935, l_feature_name, 1, RTWCT(10691, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10691, 0xF80003A5, 0); /* active */
...
EIF_TYPED_VALUE F936_11480 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F936_11481 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F936_11482 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F936_22829 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 935, Current, 0, 22828);
	RTSA(dtype);
	RTME(dtype, 0);
