...
extern EIF_TYPED_VALUE F949_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F949_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 948, Current, 0, 0, 5351);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(948, Current, 5351);
	RTIV(Current, RTAL);
	RTHOOK(1);
