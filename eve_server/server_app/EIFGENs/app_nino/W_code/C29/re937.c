...
extern EIF_TYPED_VALUE F937_12308(EIF_REFERENCE);
...
EIF_TYPED_VALUE F937_12308 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 936, Current, 0, 0, 5543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(936, Current, 5543);
	RTIV(Current, RTAL);
	RTHOOK(1);
