...
extern EIF_TYPED_VALUE F939_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F939_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 938, Current, 0, 0, 5417);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(938, Current, 5417);
	RTIV(Current, RTAL);
	RTHOOK(1);
