...
extern EIF_TYPED_VALUE F939_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F939_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 938, Current, 0, 0, 5977);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(938, Current, 5977);
	RTIV(Current, RTAL);
	RTHOOK(1);
