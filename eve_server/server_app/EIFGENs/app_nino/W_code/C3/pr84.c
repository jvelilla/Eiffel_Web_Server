...
extern void F84_6955(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F84_6956(EIF_REFERENCE);
extern EIF_TYPED_VALUE F84_6957(EIF_REFERENCE);
extern EIF_TYPED_VALUE F84_6959(EIF_REFERENCE);
extern EIF_TYPED_VALUE F84_6960(EIF_REFERENCE);
extern EIF_TYPED_VALUE F84_6961(EIF_REFERENCE);
extern void F84_23475(EIF_REFERENCE, int);
...
void F84_6955 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 83, Current, 0, 1, 1329);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 83, l_feature_name, 1, 92);
	}
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6844, 0xF800005C, 0); /* process_launcher */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(6844, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F84_6956 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(6840,Dtype(Current)));
	return r;
}


/* {PROCESS_TIMER}.destroyed */
EIF_TYPED_VALUE F84_6957 (EIF_REFERENCE Current)
{
	GTCX
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6842, Dtype(Current)))(Current)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F84_6959 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F84_6960 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F84_6961 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
