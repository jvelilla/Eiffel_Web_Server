...
static EIF_TYPE_INDEX gen_type0_91 [] = {454,90,0xFFFF};
...
static struct desc_info desc_91[] = {
	...
	{1, (BODY_INDEX)-1, 454, gen_type0_91},
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 395, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 395, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 416, NULL},
...
void Init91(void)
{
	IDSC(desc_91, 0, 90);
	IDSC(desc_91 + 1, 4, 90);
	IDSC(desc_91 + 34, 470, 90);
	IDSC(desc_91 + 38, 435, 90);
	IDSC(desc_91 + 44, 427, 90);
}
