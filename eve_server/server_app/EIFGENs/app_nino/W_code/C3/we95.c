...
extern EIF_TYPED_VALUE F95_7842(EIF_REFERENCE);
extern EIF_TYPED_VALUE F95_7843(EIF_REFERENCE);
...
#endif
#ifndef INLINE_F95_7842
static EIF_INTEGER_32 inline_F95_7842 (void)
{
	return (EIF_INTEGER_32) (PROCESS_VM_WRITE)
	;
}
#define INLINE_F95_7842
#endif
#ifndef INLINE_F95_7843
static EIF_INTEGER_32 inline_F95_7843 (void)
{
	return (EIF_INTEGER_32) (SYNCHRONIZE)
	;
}
#define INLINE_F95_7843
#endif
...
EIF_TYPED_VALUE F95_7837 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 94, Current, 0, 0, 1563);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
...
EIF_TYPED_VALUE F95_7838 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 94, Current, 0, 0, 1564);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
...
EIF_TYPED_VALUE F95_7842 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F95_7843 (EIF_REFERENCE Current)
{
	GTCX
