...
extern EIF_TYPED_VALUE F93_7796(EIF_REFERENCE);
extern EIF_TYPED_VALUE F93_7797(EIF_REFERENCE);
extern EIF_TYPED_VALUE F93_7798(EIF_REFERENCE);
...
EIF_TYPED_VALUE F93_7796 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F93_7797 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F93_7798 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 92, Current, 0, 0, 1521);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(7603, "fractional_second", tr1));
