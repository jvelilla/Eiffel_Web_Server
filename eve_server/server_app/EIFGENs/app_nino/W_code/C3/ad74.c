...
extern EIF_TYPED_VALUE F74_6954(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet();

extern EIF_TYPED_VALUE F74_6955(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet6();
...
/* {ADDRINFO}.af_inet */
EIF_TYPED_VALUE F74_6954 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 73, Current, 0, 0, 1318);
	RTSA(Dtype(Current));
	RTSC;
