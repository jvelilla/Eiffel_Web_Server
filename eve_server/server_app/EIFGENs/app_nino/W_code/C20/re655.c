...
extern EIF_TYPED_VALUE F655_12308(EIF_REFERENCE);
...
EIF_TYPED_VALUE F655_12308 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 654, Current, 0, 0, 5536);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(654, Current, 5536);
	RTIV(Current, RTAL);
	RTHOOK(1);
