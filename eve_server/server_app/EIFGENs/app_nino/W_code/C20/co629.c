...
extern EIF_TYPED_VALUE F629_9603(EIF_REFERENCE);
extern EIF_TYPED_VALUE F629_9604(EIF_REFERENCE);
extern EIF_TYPED_VALUE F629_9605(EIF_REFERENCE);
extern void F629_9606(EIF_REFERENCE);
extern void F629_9607(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F629_9603 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 628, Current, 0, 0, 2760);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(628, Current, 2760);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F629_9604 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F629_9605 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 628, Current, 0, 0, 2762);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(628, Current, 2762);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F629_9606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 628, Current, 0, 0, 2763);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(628, Current, 2763);
	RTIV(Current, RTAL);
...
void F629_9607 (EIF_REFERENCE Current)
{
	GTCX
