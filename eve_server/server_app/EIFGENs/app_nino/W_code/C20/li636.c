...
extern EIF_TYPED_VALUE F636_12506(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F636_12507(EIF_REFERENCE);
extern EIF_TYPED_VALUE F636_12508(EIF_REFERENCE);
extern void F636_22964(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F636_12506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 635, Current, 2, 1, 6945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(635, Current, 6945);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9252, "item", arg1))(arg1)).it_n4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F636_12507 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 635, Current, 0, 0, 6946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(635, Current, 6946);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F636_12508 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 635, Current, 0, 0, 6947);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(635, Current, 6947);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F636_22964 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 635, Current, 0, 22963);
	RTSA(dtype);
	RTME(dtype, 0);
