...
extern EIF_TYPED_VALUE F654_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F654_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 653, Current, 0, 0, 5344);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(653, Current, 5344);
	RTIV(Current, RTAL);
	RTHOOK(1);
