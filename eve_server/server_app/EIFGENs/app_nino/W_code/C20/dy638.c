...
extern void F638_12480(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F638_12482(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F638_12483(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F638_12487(EIF_REFERENCE);
...
void F638_12480 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 637, Current, 1, 1, 6820);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(637, Current, 6820);
	RTIV(Current, RTAL);
...
void F638_12482 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 637, Current, 0, 1, 6821);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(637, Current, 6821);
	RTCC(arg1, 637, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
body:;
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11346, dtype))(Current, ub1x);
		RTHOOK(8);
...
void F638_12483 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 637, Current, 0, 1, 6822);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(637, Current, 6822);
	RTCC(arg1, 637, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F638_12487 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 637, Current, 0, 0, 6823);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(637, Current, 6823);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
