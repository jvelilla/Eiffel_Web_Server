...
extern EIF_TYPED_VALUE F632_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F632_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 631, Current, 0, 0, 5969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(631, Current, 5969);
	RTIV(Current, RTAL);
	RTHOOK(1);
