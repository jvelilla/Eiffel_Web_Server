...
extern EIF_TYPED_VALUE F655_12250(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F655_12251(EIF_REFERENCE);
extern EIF_TYPED_VALUE F655_12252(EIF_REFERENCE);
extern void F655_22690(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F655_12250 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 654, Current, 2, 1, 6671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(654, Current, 6671);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						ti8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9218, "item", arg1))(arg1)).it_i8);
...
/* {LIST}.after */
EIF_TYPED_VALUE F655_12251 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 654, Current, 0, 0, 6672);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(654, Current, 6672);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F655_12252 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 654, Current, 0, 0, 6673);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(654, Current, 6673);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F655_22690 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 654, Current, 0, 22689);
	RTSA(dtype);
	RTME(dtype, 0);
