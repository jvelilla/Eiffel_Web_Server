...
extern EIF_TYPED_VALUE F639_12343(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F639_12344(EIF_REFERENCE);
extern EIF_TYPED_VALUE F639_12345(EIF_REFERENCE);
extern void F639_22783(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F639_12343 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 638, Current, 2, 1, 6760);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(638, Current, 6760);
	RTCC(arg1, 638, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
...
/* {LIST}.after */
EIF_TYPED_VALUE F639_12344 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 638, Current, 0, 0, 6761);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(638, Current, 6761);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F639_12345 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 638, Current, 0, 0, 6762);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(638, Current, 6762);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F639_22783 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 638, Current, 0, 22782);
	RTSA(dtype);
	RTME(dtype, 0);
