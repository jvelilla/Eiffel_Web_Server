...
extern EIF_TYPED_VALUE F640_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F640_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 639, Current, 0, 0, 5528);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(639, Current, 5528);
	RTIV(Current, RTAL);
	RTHOOK(1);
