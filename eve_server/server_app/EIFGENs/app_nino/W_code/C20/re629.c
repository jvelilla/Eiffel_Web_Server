...
extern EIF_TYPED_VALUE F629_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F629_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 628, Current, 0, 0, 5343);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(628, Current, 5343);
	RTIV(Current, RTAL);
	RTHOOK(1);
