...
extern EIF_TYPED_VALUE F218_9748(EIF_REFERENCE);
extern EIF_TYPED_VALUE F218_9749(EIF_REFERENCE);
...
EIF_TYPED_VALUE F218_9748 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 217, Current, 0, 0, 2974);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(217, Current, 2974);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8676, 170))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 217, Current, 0, 0, 2975);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(217, Current, 2975);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
