...
extern EIF_TYPED_VALUE F225_10771(EIF_REFERENCE);
...
RTOID (F225_10771)
EIF_TYPED_VALUE F225_10771 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 224, Current, 0, 0, 3690);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(224, Current, 3690);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
