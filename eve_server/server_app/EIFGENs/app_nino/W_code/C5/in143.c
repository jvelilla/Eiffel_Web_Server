...
extern EIF_TYPED_VALUE F143_8519(EIF_REFERENCE);
extern EIF_TYPED_VALUE F143_8520(EIF_REFERENCE);
extern EIF_TYPED_VALUE F143_8521(EIF_REFERENCE);
extern void F143_8522(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F143_8519 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 142, Current, 1, 0, 2120);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(142, Current, 2120);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(8259, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F143_8520)
EIF_TYPED_VALUE F143_8520 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 142, Current, 0, 0, 2121);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(142, Current, 2121);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F143_8521)
EIF_TYPED_VALUE F143_8521 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 142, Current, 0, 0, 2122);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(142, Current, 2122);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000096, 0,0); /* Result */
...
void F143_8522 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 142, Current, 0, 1, 2123);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(142, Current, 2123);
...
{
	GTCX
	RTOTS (8520,F143_8520)
	RTOTS (8521,F143_8521)
}
