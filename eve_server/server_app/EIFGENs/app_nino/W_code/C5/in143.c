...
extern EIF_TYPED_VALUE F143_8511(EIF_REFERENCE);
extern EIF_TYPED_VALUE F143_8512(EIF_REFERENCE);
extern EIF_TYPED_VALUE F143_8513(EIF_REFERENCE);
extern void F143_8514(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F143_8511 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 142, Current, 1, 0, 2110);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(142, Current, 2110);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(8254, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F143_8512)
EIF_TYPED_VALUE F143_8512 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 142, Current, 0, 0, 2111);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(142, Current, 2111);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F143_8513)
EIF_TYPED_VALUE F143_8513 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 142, Current, 0, 0, 2112);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(142, Current, 2112);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000096, 0,0); /* Result */
...
void F143_8514 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 142, Current, 0, 1, 2113);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(142, Current, 2113);
...
{
	GTCX
	RTOTS (8512,F143_8512)
	RTOTS (8513,F143_8513)
}
