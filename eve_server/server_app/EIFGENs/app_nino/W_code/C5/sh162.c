...
extern EIF_TYPED_VALUE F162_9065(EIF_REFERENCE);
...
RTOID (F162_9065)
EIF_TYPED_VALUE F162_9065 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 161, Current, 0, 0, 2351);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(161, Current, 2351);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
