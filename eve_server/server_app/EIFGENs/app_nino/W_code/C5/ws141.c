...
extern EIF_TYPED_VALUE F141_8498(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F141_8499(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F141_8498 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 140, Current, 0, 1, 2078);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(140, Current, 2078);
	if (arg1) {
		RTCC(arg1, 140, l_feature_name, 1, 404);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8176, 131))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr1);
...
void F141_8499 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 140, Current, 8, 4, 2079);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(140, Current, 2079);
	if (arg1) {
		RTCC(arg1, 140, l_feature_name, 1, 404);
	}
	if (arg2) {
		RTCC(arg2, 140, l_feature_name, 2, 400);
	}
	if (arg3) {
		{
			...
			RTCC(arg3, 140, l_feature_name, 3, typres0);
		}
	}
	if (arg4) {
		{
			...
			typres0 = (typcache0 != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(Dftype(Current), typarr0)));
			RTCC(arg4, 140, l_feature_name, 4, typres0);
		}
	}
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_CHECK) {
		...
		tb1 = '\01';
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16920, "is_chunked_input", arg2))(arg2)).it_b);
		if ((EIF_BOOLEAN) !tb2) {
			ti4_1 = *(EIF_INTEGER_32 *)(loc1 + RTVA(15730, "count", loc1));
			tu8_1 = *(EIF_NATURAL_64 *)(arg2 + RTVA(16958, "content_length_value", arg2));
			RTNHOOK(5,1);
	...
	if ((EIF_BOOLEAN) (loc2 > ((EIF_INTEGER_32) 0L))) {
		...
		for (;;) {
			...
			RTHOOK(16);
			tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15587, "is_empty", loc6))(loc6)).it_b);
			if ((EIF_BOOLEAN) !tb1) {
				RTHOOK(17);
				...
				if ((EIF_BOOLEAN) (loc5 > ((EIF_INTEGER_32) 0L))) {
					...
					RTHOOK(20);
					RTDBGAL(Current, 8, 0xF8000181, 0, 0); /* loc8 */
