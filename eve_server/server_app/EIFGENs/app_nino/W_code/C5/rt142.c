...
extern void F142_8500(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F142_8501(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F142_8500 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 141, Current, 0, 1, 2080);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(141, Current, 2080);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F142_8501 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 141, Current, 0, 1, 2081);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(141, Current, 2081);
	if (arg1) {
		RTCC(arg1, 141, l_feature_name, 1, 389);
	}
	RTIV(Current, RTAL);
