...
extern EIF_TYPED_VALUE F142_8503(EIF_REFERENCE);
extern EIF_TYPED_VALUE F142_8504(EIF_REFERENCE);
extern EIF_TYPED_VALUE F142_8505(EIF_REFERENCE);
extern void F142_8506(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F142_8503 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 141, Current, 1, 0, 2102);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(141, Current, 2102);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(8246, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F142_8504)
EIF_TYPED_VALUE F142_8504 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 141, Current, 0, 0, 2103);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(141, Current, 2103);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F142_8505)
EIF_TYPED_VALUE F142_8505 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 141, Current, 0, 0, 2104);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(141, Current, 2104);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000095, 0,0); /* Result */
...
void F142_8506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 141, Current, 0, 1, 2105);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(141, Current, 2105);
...
{
	GTCX
	RTOTS (8504,F142_8504)
	RTOTS (8505,F142_8505)
}
