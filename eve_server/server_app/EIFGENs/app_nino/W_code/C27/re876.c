...
extern EIF_TYPED_VALUE F876_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F876_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 875, Current, 0, 0, 5534);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(875, Current, 5534);
	RTIV(Current, RTAL);
	RTHOOK(1);
