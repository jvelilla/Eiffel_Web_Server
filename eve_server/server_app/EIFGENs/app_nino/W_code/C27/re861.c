...
extern EIF_TYPED_VALUE F861_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F861_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 860, Current, 0, 0, 5415);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(860, Current, 5415);
	RTIV(Current, RTAL);
	RTHOOK(1);
