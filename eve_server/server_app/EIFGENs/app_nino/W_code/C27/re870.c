...
extern EIF_TYPED_VALUE F870_12308(EIF_REFERENCE);
...
EIF_TYPED_VALUE F870_12308 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 869, Current, 0, 0, 5541);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(869, Current, 5541);
	RTIV(Current, RTAL);
	RTHOOK(1);
