...
extern EIF_TYPED_VALUE F871_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F871_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 870, Current, 0, 0, 5975);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(870, Current, 5975);
	RTIV(Current, RTAL);
	RTHOOK(1);
