...
extern EIF_TYPED_VALUE F866_12235(EIF_REFERENCE);
extern EIF_TYPED_VALUE F866_12236(EIF_REFERENCE);
extern void F866_12242(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F866_12245(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F866_12246(EIF_REFERENCE);
extern EIF_TYPED_VALUE F866_12247(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F866_12235 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 865, Current, 0, 0, 6624);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(865, Current, 6624);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F866_12236 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 865, Current, 0, 0, 6625);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(865, Current, 6625);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F866_12242 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 865, Current, 0, 1, 6626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(865, Current, 6626);
	RTIV(Current, RTAL);
...
void F866_12245 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 865, Current, 0, 1, 6621);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(865, Current, 6621);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F866_12246 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 865, Current, 0, 0, 6622);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(865, Current, 6622);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F866_12247 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 865, Current, 2, 1, 6623);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(865, Current, 6623);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
