...
static EIF_TYPE_INDEX gen_type9_881 [] = {877,0xFFF8,1,0xFFFF};
...
static struct desc_info desc_881[] = {
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 877, gen_type9_881},
...
void Init881(void)
{
	...
	IDSC(desc_881 + 43, 362, 880);
	IDSC(desc_881 + 52, 357, 880);
	IDSC(desc_881 + 58, 361, 880);
}
