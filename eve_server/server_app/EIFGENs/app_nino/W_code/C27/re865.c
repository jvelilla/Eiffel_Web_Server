...
extern EIF_TYPED_VALUE F865_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F865_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 864, Current, 0, 0, 5349);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(864, Current, 5349);
	RTIV(Current, RTAL);
	RTHOOK(1);
