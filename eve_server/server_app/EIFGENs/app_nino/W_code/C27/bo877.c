...
extern EIF_TYPED_VALUE F877_10052(EIF_REFERENCE);
extern void F877_23494(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F877_10052 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 876, Current, 0, 0, 3244);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(876, Current, 3244);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F877_23494 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 876, Current, 0, 23493);
	RTSA(dtype);
	RTME(dtype, 0);
