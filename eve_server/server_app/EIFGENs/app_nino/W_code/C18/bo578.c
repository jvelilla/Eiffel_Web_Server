...
extern EIF_TYPED_VALUE F578_9584(EIF_REFERENCE);
extern void F578_22658(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F578_9584 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 577, Current, 0, 0, 2824);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(577, Current, 2824);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F578_22658 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 577, Current, 0, 22657);
	RTSA(dtype);
	RTME(dtype, 0);
