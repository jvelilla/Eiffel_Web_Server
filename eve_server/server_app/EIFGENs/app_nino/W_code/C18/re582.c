...
extern EIF_TYPED_VALUE F582_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F582_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 581, Current, 0, 0, 5342);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(581, Current, 5342);
	RTIV(Current, RTAL);
	RTHOOK(1);
