...
extern EIF_TYPED_VALUE F568_9620(EIF_REFERENCE);
extern void F568_22936(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F568_9620 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 567, Current, 0, 0, 2856);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(567, Current, 2856);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F568_22936 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 567, Current, 0, 22935);
	RTSA(dtype);
	RTME(dtype, 0);
