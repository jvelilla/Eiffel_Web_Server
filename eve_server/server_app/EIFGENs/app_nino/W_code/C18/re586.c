...
extern EIF_TYPED_VALUE F586_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F586_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 585, Current, 0, 0, 5408);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(585, Current, 5408);
	RTIV(Current, RTAL);
	RTHOOK(1);
