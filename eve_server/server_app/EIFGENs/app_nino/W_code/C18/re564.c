...
extern EIF_TYPED_VALUE F564_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F564_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 563, Current, 0, 0, 5967);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(563, Current, 5967);
	RTIV(Current, RTAL);
	RTHOOK(1);
