...
extern EIF_TYPED_VALUE F593_9592(EIF_REFERENCE);
extern EIF_TYPED_VALUE F593_9593(EIF_REFERENCE);
extern EIF_TYPED_VALUE F593_9594(EIF_REFERENCE);
extern void F593_9595(EIF_REFERENCE);
extern void F593_9596(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F593_9592 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 592, Current, 0, 0, 2734);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(592, Current, 2734);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F593_9593 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F593_9594 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 592, Current, 0, 0, 2736);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(592, Current, 2736);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F593_9595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 592, Current, 0, 0, 2737);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(592, Current, 2737);
	RTIV(Current, RTAL);
...
void F593_9596 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 592, Current, 0, 0, 2738);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(592, Current, 2738);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
