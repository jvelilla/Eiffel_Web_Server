...
extern EIF_TYPED_VALUE F358_18602(EIF_REFERENCE);
...
EIF_TYPED_VALUE F358_18602 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 357, Current, 0, 0, 12162);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(357, Current, 12162);
	RTIV(Current, RTAL);
	RTHOOK(1);
