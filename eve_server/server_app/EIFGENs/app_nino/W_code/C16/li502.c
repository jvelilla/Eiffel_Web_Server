...
extern EIF_TYPED_VALUE F502_10348(EIF_REFERENCE);
extern void F502_10349(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F502_10350(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F502_10348 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F502_10349 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 501, Current, 0, 1, 3572);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(501, Current, 3572);
	RTCC(arg1, 501, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9655, 0xF80001F5, 0); /* right */
...
void F502_10350 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 501, Current, 0, 0, 3573);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(501, Current, 3573);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9655, 0xF80001F5, 0); /* right */
