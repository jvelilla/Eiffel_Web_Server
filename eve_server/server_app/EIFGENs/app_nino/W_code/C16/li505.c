...
extern void F505_11350(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F505_11351(EIF_REFERENCE);
extern EIF_TYPED_VALUE F505_11352(EIF_REFERENCE);
extern EIF_TYPED_VALUE F505_11353(EIF_REFERENCE);
extern void F505_22953(EIF_REFERENCE, int);
...
void F505_11350 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 504, Current, 0, 3, 4253);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(504, Current, 4253);
	RTCC(arg1, 504, l_feature_name, 1, RTWCT(10568, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10568, 0xF80001F5, 0); /* active */
...
EIF_TYPED_VALUE F505_11351 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F505_11352 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F505_11353 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F505_22953 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 504, Current, 0, 22952);
	RTSA(dtype);
	RTME(dtype, 0);
