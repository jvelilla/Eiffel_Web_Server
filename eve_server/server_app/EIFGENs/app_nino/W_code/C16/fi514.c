...
extern void F514_22657(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F514_9582 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 513, Current, 0, 0, 2790);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(513, Current, 2790);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F514_22657 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 513, Current, 0, 22656);
	RTSA(dtype);
	RTME(dtype, 0);
