...
extern void F506_9594(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F506_9594 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 505, Current, 0, 1, 2966);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(505, Current, 2966);
	RTCC(arg1, 505, l_feature_name, 1, RTWCT(9177, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
