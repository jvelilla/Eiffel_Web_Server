...
extern EIF_TYPED_VALUE F517_9606(EIF_REFERENCE);
extern void F517_22812(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F517_9606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 516, Current, 0, 0, 2994);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(516, Current, 2994);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F517_22812 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 516, Current, 0, 22811);
	RTSA(dtype);
	RTME(dtype, 0);
