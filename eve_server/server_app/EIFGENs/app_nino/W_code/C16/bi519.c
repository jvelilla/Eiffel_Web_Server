...
extern EIF_TYPED_VALUE F519_10350(EIF_REFERENCE);
extern void F519_10353(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F519_23500(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F519_10350 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 518, Current, 0, 0, 3723);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(518, Current, 3723);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F519_10353 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 518, Current, 0, 1, 3724);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(518, Current, 3724);
	RTCC(arg1, 518, l_feature_name, 1, RTWCT(9702, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9801, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9803, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F519_23500 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 518, Current, 0, 23499);
	RTSA(dtype);
	RTME(dtype, 0);
