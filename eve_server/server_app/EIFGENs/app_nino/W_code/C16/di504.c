...
extern EIF_TYPED_VALUE F504_9652(EIF_REFERENCE);
extern EIF_TYPED_VALUE F504_9653(EIF_REFERENCE);
extern void F504_9654(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F504_22932(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F504_9652 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 503, Current, 0, 0, 3061);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(503, Current, 3061);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F504_9653 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 503, Current, 0, 0, 3062);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(503, Current, 3062);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DISPENSER}.append */
void F504_9654 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 503, Current, 0, 1, 3063);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(503, Current, 3063);
	if (arg1) {
		{
...
void F504_22932 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 503, Current, 0, 22931);
	RTSA(dtype);
	RTME(dtype, 0);
