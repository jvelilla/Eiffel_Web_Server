...
extern EIF_TYPED_VALUE F523_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F523_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 522, Current, 0, 0, 5340);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(522, Current, 5340);
	RTIV(Current, RTAL);
	RTHOOK(1);
