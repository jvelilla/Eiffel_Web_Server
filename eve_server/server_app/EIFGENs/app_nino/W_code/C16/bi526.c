...
extern EIF_TYPED_VALUE F526_9882(EIF_REFERENCE);
extern void F526_9885(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F526_22664(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F526_9882 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 525, Current, 0, 0, 3318);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(525, Current, 3318);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F526_9885 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 525, Current, 0, 1, 3319);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(525, Current, 3319);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9361, dtype))(Current)).it_b);
...
/* {BILINEAR}._invariant */
void F526_22664 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 525, Current, 0, 22663);
	RTSA(dtype);
	RTME(dtype, 0);
