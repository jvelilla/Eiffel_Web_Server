...
extern void F507_9631(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F507_9631 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 506, Current, 0, 1, 2993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(506, Current, 2993);
	RTCC(arg1, 506, l_feature_name, 1, RTWCT(9214, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
