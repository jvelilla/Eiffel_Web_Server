...
extern EIF_TYPED_VALUE F524_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F524_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 523, Current, 0, 0, 5525);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(523, Current, 5525);
	RTIV(Current, RTAL);
	RTHOOK(1);
