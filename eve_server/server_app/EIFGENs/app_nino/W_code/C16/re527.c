...
extern EIF_TYPED_VALUE F527_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F527_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 526, Current, 0, 0, 5406);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(526, Current, 5406);
	RTIV(Current, RTAL);
	RTHOOK(1);
