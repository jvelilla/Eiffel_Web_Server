...
extern EIF_TYPED_VALUE F616_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F616_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 615, Current, 0, 0, 5409);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(615, Current, 5409);
	RTIV(Current, RTAL);
	RTHOOK(1);
