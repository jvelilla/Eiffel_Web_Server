...
extern EIF_TYPED_VALUE F618_9555(EIF_REFERENCE);
extern EIF_TYPED_VALUE F618_9556(EIF_REFERENCE);
extern EIF_TYPED_VALUE F618_9557(EIF_REFERENCE);
extern void F618_9558(EIF_REFERENCE);
extern void F618_9559(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F618_9555 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 617, Current, 0, 0, 2712);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(617, Current, 2712);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F618_9556 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F618_9557 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 617, Current, 0, 0, 2714);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(617, Current, 2714);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F618_9558 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 617, Current, 0, 0, 2715);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(617, Current, 2715);
	RTIV(Current, RTAL);
...
void F618_9559 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 617, Current, 0, 0, 2716);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(617, Current, 2716);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
