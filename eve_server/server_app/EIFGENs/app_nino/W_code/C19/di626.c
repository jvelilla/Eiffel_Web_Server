...
extern EIF_TYPED_VALUE F626_9652(EIF_REFERENCE);
extern EIF_TYPED_VALUE F626_9653(EIF_REFERENCE);
extern void F626_9654(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F626_22932(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F626_9652 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 625, Current, 0, 0, 3065);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(625, Current, 3065);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F626_9653 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 625, Current, 0, 0, 3066);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(625, Current, 3066);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DISPENSER}.append */
void F626_9654 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 625, Current, 0, 1, 3067);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(625, Current, 3067);
	if (arg1) {
		{
...
void F626_22932 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 625, Current, 0, 22931);
	RTSA(dtype);
	RTME(dtype, 0);
