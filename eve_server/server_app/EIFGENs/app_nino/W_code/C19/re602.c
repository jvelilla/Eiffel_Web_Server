...
extern EIF_TYPED_VALUE F602_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F602_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 601, Current, 0, 0, 5968);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(601, Current, 5968);
	RTIV(Current, RTAL);
	RTHOOK(1);
