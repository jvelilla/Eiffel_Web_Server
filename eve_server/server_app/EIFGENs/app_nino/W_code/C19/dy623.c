...
extern EIF_TYPED_VALUE F623_13000(EIF_REFERENCE);
extern EIF_TYPED_VALUE F623_13001(EIF_REFERENCE);
extern void F623_13007(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F623_13010(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F623_13011(EIF_REFERENCE);
extern EIF_TYPED_VALUE F623_13012(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F623_13000 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 622, Current, 0, 0, 7293);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(622, Current, 7293);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F623_13001 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 622, Current, 0, 0, 7294);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(622, Current, 7294);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F623_13007 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 622, Current, 0, 1, 7295);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 7295);
	RTIV(Current, RTAL);
...
void F623_13010 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 622, Current, 0, 1, 7296);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 7296);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F623_13011 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 622, Current, 0, 0, 7297);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 7297);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F623_13012 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 622, Current, 2, 1, 7298);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 7298);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ur8_1 = tr8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9646, "extend", Result))(Result, ur8_1x);
		RTHOOK(9);
