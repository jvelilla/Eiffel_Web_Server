...
extern void F623_12387(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F623_12389(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F623_12390(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F623_12394(EIF_REFERENCE);
...
void F623_12387 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 622, Current, 1, 1, 6727);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 6727);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		uu8_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11252, dtype))(Current, uu8_1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			uu8_1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11254, dtype))(Current, uu8_1x);
			RTHOOK(8);
...
void F623_12389 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 622, Current, 0, 1, 6728);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 6728);
	RTCC(arg1, 622, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tu8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9218, "item", arg1))(arg1)).it_n8);
		uu8_1 = tu8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11253, dtype))(Current, uu8_1x);
		RTHOOK(8);
...
void F623_12390 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 622, Current, 0, 1, 6729);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 6729);
	RTCC(arg1, 622, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F623_12394 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 622, Current, 0, 0, 6730);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 6730);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
