...
extern EIF_TYPED_VALUE F611_12372(EIF_REFERENCE);
extern EIF_TYPED_VALUE F611_12373(EIF_REFERENCE);
extern void F611_12379(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F611_12382(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F611_12383(EIF_REFERENCE);
extern EIF_TYPED_VALUE F611_12384(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F611_12372 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 610, Current, 0, 0, 6738);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(610, Current, 6738);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F611_12373 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 610, Current, 0, 0, 6739);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(610, Current, 6739);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F611_12379 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 610, Current, 0, 1, 6740);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(610, Current, 6740);
	RTIV(Current, RTAL);
...
void F611_12382 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 610, Current, 0, 1, 6741);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(610, Current, 6741);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F611_12383 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 610, Current, 0, 0, 6742);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(610, Current, 6742);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F611_12384 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 610, Current, 2, 1, 6743);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(610, Current, 6743);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uu8_1 = tu8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9201, "extend", Result))(Result, uu8_1x);
		RTHOOK(9);
