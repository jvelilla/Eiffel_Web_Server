...
extern EIF_TYPED_VALUE F603_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F603_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 602, Current, 0, 0, 5527);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(602, Current, 5527);
	RTIV(Current, RTAL);
	RTHOOK(1);
