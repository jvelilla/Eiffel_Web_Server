...
extern EIF_TYPED_VALUE F617_12498(EIF_REFERENCE);
extern EIF_TYPED_VALUE F617_12499(EIF_REFERENCE);
extern void F617_12505(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F617_12508(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F617_12509(EIF_REFERENCE);
extern EIF_TYPED_VALUE F617_12510(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F617_12498 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F617_12499 (EIF_REFERENCE Current)
{
	GTCX
...
/* {DYNAMIC_CHAIN}.prune */
void F617_12505 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 616, Current, 0, 1, 6866);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F617_12508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 616, Current, 0, 1, 6867);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(616, Current, 6867);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F617_12509 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 616, Current, 0, 0, 6868);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(616, Current, 6868);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F617_12510 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 616, Current, 2, 1, 6869);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(616, Current, 6869);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uu8_1 = tu8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9244, "extend", Result))(Result, uu8_1x);
		RTHOOK(9);
