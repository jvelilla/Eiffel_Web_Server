...
extern EIF_TYPED_VALUE F606_12506(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F606_12507(EIF_REFERENCE);
extern EIF_TYPED_VALUE F606_12508(EIF_REFERENCE);
extern void F606_22964(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F606_12506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 605, Current, 2, 1, 6941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(605, Current, 6941);
...
/* {LIST}.after */
EIF_TYPED_VALUE F606_12507 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 605, Current, 0, 0, 6942);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(605, Current, 6942);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F606_12508 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 605, Current, 0, 0, 6943);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(605, Current, 6943);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F606_22964 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 605, Current, 0, 22963);
	RTSA(dtype);
	RTME(dtype, 0);
