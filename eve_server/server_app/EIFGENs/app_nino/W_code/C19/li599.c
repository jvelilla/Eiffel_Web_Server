...
extern EIF_TYPED_VALUE F599_12273(EIF_REFERENCE);
extern EIF_TYPED_VALUE F599_12274(EIF_REFERENCE);
extern void F599_12275(EIF_REFERENCE);
extern void F599_12276(EIF_REFERENCE);
extern EIF_TYPED_VALUE F599_12277(EIF_REFERENCE);
extern EIF_TYPED_VALUE F599_12278(EIF_REFERENCE);
...
EIF_TYPED_VALUE F599_12273 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 598, Current, 1, 0, 5497);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(598, Current, 5497);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		...
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9759, 599))(Current)).it_b);
	} else {
		RTHOOK(4);
...
EIF_TYPED_VALUE F599_12274 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 598, Current, 0, 0, 5498);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(598, Current, 5498);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(11375, dtype));
	if (tb1) {
		...
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9760, 599))(Current)).it_b);
	} else {
		RTHOOK(3);
		RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F599_12275 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 598, Current, 0, 0, 5499);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(598, Current, 5499);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(11381, 599))(Current);
	RTHOOK(2);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(11375, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 11384, 0xF800024D, 0); /* active */
...
void F599_12276 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 598, Current, 2, 0, 5494);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(598, Current, 5494);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
body:;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9761, 599))(Current);
	RTHOOK(3);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(11375, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F599_12277 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F599_12278 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
