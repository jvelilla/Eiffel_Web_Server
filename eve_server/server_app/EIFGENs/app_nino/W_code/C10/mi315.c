...
extern void F315_12318(EIF_REFERENCE);
extern EIF_TYPED_VALUE F315_12319(EIF_REFERENCE);
...
void F315_12318 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 314, Current, 2, 0, 5126);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(314, Current, 5126);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 314, Current, 0, 0, 5127);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(314, Current, 5127);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
