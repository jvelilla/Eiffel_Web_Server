...
extern void F299_12091(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F299_12092(EIF_REFERENCE);
...
void F299_12091 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 298, Current, 0, 1, 4900);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(298, Current, 4900);
	if (arg1) {
		RTCC(arg1, 298, l_feature_name, 1, 106);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7971, 0xF800006A, 0); /* process_launcher */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(7971, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(5);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7974, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 7973, 0xF8000157, 0); /* mutex */
	
	tr1 = RTLNSMART(eif_non_attached_type(RTWCT(7973, dtype, Dftype(Current))));
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(12577, Dtype(tr1)))(tr1);
	RTNHOOK(7,1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7973, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(8);
...
void F299_12092 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 298, Current, 2, 0, 4901);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(298, Current, 4901);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(4,1);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(7883, "read_output_stream", tr1))(tr1);
		RTHOOK(5);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7971, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(5,1);
		ti4_1 = *(EIF_INTEGER_32 *)(tr1 + RTVA(7879, "last_output_bytes", tr1));
