...
static EIF_TYPE_INDEX gen_type0_311 [] = {459,310,0xFFFF};
...
static struct desc_info desc_311[] = {
	...
	{1, (BODY_INDEX)-1, 459, gen_type0_311},
...
void Init311(void)
{
	...
	IDSC(desc_311 + 34, 436, 310);
	IDSC(desc_311 + 38, 288, 310);
}
