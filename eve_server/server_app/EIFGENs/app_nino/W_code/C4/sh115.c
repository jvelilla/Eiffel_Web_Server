...
extern EIF_TYPED_VALUE F115_8201(EIF_REFERENCE);
...
RTOID (F115_8201)
EIF_TYPED_VALUE F115_8201 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 114, Current, 0, 0, 1814);
	RTSA(Dtype(Current));
	RTSC;
