...
extern EIF_TYPED_VALUE F129_8334(EIF_REFERENCE);
...
EIF_TYPED_VALUE F129_8334 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 128, Current, 0, 0, 1964);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {730,0,0xFFFF};
