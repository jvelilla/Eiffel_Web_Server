...
extern void F101_7945(EIF_REFERENCE);
extern void F101_7946(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F101_22647(EIF_REFERENCE, int);
...
void F101_7945 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 100, Current, 0, 0, 1649);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F101_7946 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 100, Current, 0, 1, 1650);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7785, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(5);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7784, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(5,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(11844, "unlock", tr1))(tr1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 100, Current, 0, 0, 1651);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	Result = *(EIF_BOOLEAN *)(Current + RTWA(7783, dtype));
	RTHOOK(4);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7784, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(11844, "unlock", tr1))(tr1);
...
void F101_22647 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 100, Current, 0, 22646);
	RTSA(dtype);
	RTME(dtype, 0);
