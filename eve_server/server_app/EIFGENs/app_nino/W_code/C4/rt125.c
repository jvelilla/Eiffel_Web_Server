...
extern void F125_8307(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F125_8308(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F125_8307 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 124, Current, 0, 1, 1919);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(124, Current, 1919);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F125_8308 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 124, Current, 0, 1, 1918);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(124, Current, 1918);
	if (arg1) {
