...
extern EIF_TYPED_VALUE F122_8250(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F122_8250 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 121, Current, 0, 1, 1863);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(121, Current, 1863);
	if (arg1) {
	...
	if (tb1) {
		...
		Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8038, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	} else {
		RTHOOK(3);
		...
		if (tb1) {
			...
			if (tb1) {
				...
				Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8037, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			} else {
				RTHOOK(7);
				...
				if (tb1) {
					...
					Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8039, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				} else {
					RTHOOK(9);
					...
					if (tb1) {
						...
						Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8040, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
					} else {
						RTHOOK(11);
...
{
	GTCX
	RTOTC (F122_8251,1865,RTMS_EX_H("HEAD",4,1212498244));
}
...
{
	GTCX
	RTOTC (F122_8252,1866,RTMS_EX_H("GET",3,4670804));
}
...
{
	GTCX
	RTOTC (F122_8253,1867,RTMS_EX_H("TRACE",5,1380653893));
}
...
{
	GTCX
	RTOTC (F122_8254,1868,RTMS_EX_H("OPTIONS",7,347751251));
}
...
{
	GTCX
	RTOTC (F122_8255,1869,RTMS_EX_H("POST",4,1347375956));
}
...
{
	GTCX
	RTOTC (F122_8256,1870,RTMS_EX_H("PUT",3,5264724));
}
...
{
	GTCX
	RTOTC (F122_8257,1871,RTMS_EX_H("DELETE",6,1413835333));
}
...
{
	GTCX
	RTOTC (F122_8258,1872,RTMS_EX_H("CONNECT",7,831608660));
}
...
{
	GTCX
	RTOTC (F122_8259,1873,RTMS_EX_H("PATCH",5,1096655688));
}

void EIF_Minit122 (void)
{
	GTCX
	RTOTS (8251,F122_8251)
	RTOTS (8252,F122_8252)
	RTOTS (8253,F122_8253)
	RTOTS (8254,F122_8254)
