...
extern void F124_8299(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F124_8300(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F124_8299 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 123, Current, 0, 1, 1910);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(123, Current, 1910);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F124_8300 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 123, Current, 0, 1, 1911);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(123, Current, 1911);
	if (arg1) {
		RTCC(arg1, 123, l_feature_name, 1, 346);
	}
	RTIV(Current, RTAL);
