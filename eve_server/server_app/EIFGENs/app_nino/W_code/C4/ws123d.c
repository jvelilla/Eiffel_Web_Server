...
static EIF_TYPE_INDEX gen_type0_123 [] = {446,122,0xFFFF};
...
static struct desc_info desc_123[] = {
	...
	{1, (BODY_INDEX)-1, 446, gen_type0_123},
...
void Init123(void)
{
	...
	IDSC(desc_123 + 34, 372, 122);
	IDSC(desc_123 + 39, 263, 122);
}
