...
extern EIF_TYPED_VALUE F109_8096(EIF_REFERENCE);
...
EIF_TYPED_VALUE F109_8096 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 108, Current, 0, 0, 1736);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(10836, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
