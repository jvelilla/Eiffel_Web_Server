...
extern EIF_TYPED_VALUE F116_8217(EIF_REFERENCE);
...
RTOID (F116_8217)
EIF_TYPED_VALUE F116_8217 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 115, Current, 0, 0, 1832);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(115, Current, 1832);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
