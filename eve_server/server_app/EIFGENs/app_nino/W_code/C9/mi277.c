...
extern void F277_11728(EIF_REFERENCE);
extern EIF_TYPED_VALUE F277_11729(EIF_REFERENCE);
...
void F277_11728 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 276, Current, 2, 0, 4581);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(276, Current, 4581);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F277_11729)
EIF_TYPED_VALUE F277_11729 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 276, Current, 0, 0, 4582);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(276, Current, 4582);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
