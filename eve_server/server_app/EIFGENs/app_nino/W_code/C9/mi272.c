...
extern void F272_11635(EIF_REFERENCE);
extern EIF_TYPED_VALUE F272_11636(EIF_REFERENCE);
...
void F272_11635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 271, Current, 2, 0, 4488);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(271, Current, 4488);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F272_11636)
EIF_TYPED_VALUE F272_11636 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 271, Current, 0, 0, 4489);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(271, Current, 4489);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
