...
extern void F265_11607(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F265_11608(EIF_REFERENCE);
...
void F265_11607 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 264, Current, 0, 1, 4459);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(264, Current, 4459);
	if (arg1) {
		RTCC(arg1, 264, l_feature_name, 1, 96);
	}
	RTIV(Current, RTAL);
...
void F265_11608 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 264, Current, 2, 0, 4460);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(264, Current, 4460);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(4,1);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(7729, "write_input_stream", tr1))(tr1);
		RTHOOK(5);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(7783, dtype));
		if (tb1) {
			RTHOOK(6);
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7782, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(7,1);
			ti4_1 = *(EIF_INTEGER_32 *)(tr1 + RTVA(7728, "last_input_bytes", tr1));
