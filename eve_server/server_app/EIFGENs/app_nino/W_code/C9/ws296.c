...
extern void F296_13112(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F296_13113(EIF_REFERENCE);
extern EIF_TYPED_VALUE F296_13114(EIF_REFERENCE);
extern EIF_TYPED_VALUE F296_13115(EIF_REFERENCE);
extern void F296_13116(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F296_13117(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F296_13112 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 295, Current, 0, 1, 8733);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(295, Current, 8733);
	if (arg1) {
		RTCC(arg1, 295, l_feature_name, 1, 357);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 11692, 0xF8000165, 0); /* request */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(11692, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 11691, 0xF800011C, 0); /* header */
	
	tr1 = RTLNSMART(eif_non_attached_type(RTWCT(11691, dtype, Dftype(Current))));
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11080, Dtype(tr1)))(tr1);
	RTNHOOK(2,1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(11691, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_TYPED_VALUE F296_13113 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F296_13114 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(11692,Dtype(Current)));
	return r;
}


/* {WSF_PRECONDITION_FAILED_MESSAGE}.body */
EIF_TYPED_VALUE F296_13115 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(11693,Dtype(Current)));
	return r;
}


/* {WSF_PRECONDITION_FAILED_MESSAGE}.set_body */
void F296_13116 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 295, Current, 0, 1, 8731);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(295, Current, 8731);
	RTCC(arg1, 295, l_feature_name, 1, RTWCT(11693, Dtype(Current), Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 11693, 0xF8000156, 0); /* body */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(11693, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F296_13117 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 295, Current, 4, 1, 8732);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(295, Current, 8732);
	if (arg1) {
		RTCC(arg1, 295, l_feature_name, 1, 144);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	loc2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11691, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(5);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8022, 115))(Current)).it_i4);
	ui4_1 = ti4_1;
	...
	if (tb1) {
		...
		RTNHOOK(9,1);
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11692, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		RTNHOOK(9,2);
		...
		RTNHOOK(19,1);
		tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11692, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		RTNHOOK(19,2);
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(15165, "append", loc1))(loc1, ur1x);
		RTHOOK(27);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(11128, "put_content_type_text_html", loc2))(loc2);
	} else {
		RTHOOK(28);
		RTDBGAL(Current, 1, 0xF800015A, 0, 0); /* loc1 */
		...
		RTHOOK(35);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(11131, "put_content_type_text_plain", loc2))(loc2);
	}
	RTHOOK(36);
	ti4_1 = *(EIF_INTEGER_32 *)(loc1 + RTVA(15066, "count", loc1));
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(11118, "put_content_length", loc2))(loc2, ui4_1x);
	RTHOOK(37);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11089, "string", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr1);
