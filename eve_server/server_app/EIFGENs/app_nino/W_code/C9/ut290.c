...
extern EIF_TYPED_VALUE F290_11938(EIF_REFERENCE);
...
EIF_TYPED_VALUE F290_11938 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 289, Current, 0, 0, 4746);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(289, Current, 4746);
	RTIV(Current, RTAL);
	RTHOOK(1);
