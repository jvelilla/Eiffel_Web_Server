...
extern void F266_11453(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F266_11454(EIF_REFERENCE);
extern void F266_11455(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F266_11454 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F266_11455 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 265, Current, 0, 2, 4312);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(265, Current, 4312);
	if (arg1) {
		RTCC(arg1, 265, l_feature_name, 1, 400);
	}
	if (arg2) {
		RTCC(arg2, 265, l_feature_name, 2, 166);
	}
	RTIV(Current, RTAL);
