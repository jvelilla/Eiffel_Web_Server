...
extern void F676_13152(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F676_13154(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F676_13155(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F676_13159(EIF_REFERENCE);
...
void F676_13152 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 675, Current, 1, 1, 7447);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 7447);
	RTIV(Current, RTAL);
...
void F676_13154 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 675, Current, 0, 1, 7448);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 7448);
	RTCC(arg1, 675, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
body:;
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11978, dtype))(Current, ub1x);
		RTHOOK(8);
...
void F676_13155 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 675, Current, 0, 1, 7449);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 7449);
	RTCC(arg1, 675, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F676_13159 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 675, Current, 0, 0, 7450);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(675, Current, 7450);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
