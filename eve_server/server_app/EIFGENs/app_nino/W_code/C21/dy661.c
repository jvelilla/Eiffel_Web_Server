...
extern EIF_TYPED_VALUE F661_12235(EIF_REFERENCE);
extern EIF_TYPED_VALUE F661_12236(EIF_REFERENCE);
extern void F661_12242(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F661_12245(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F661_12246(EIF_REFERENCE);
extern EIF_TYPED_VALUE F661_12247(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F661_12235 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 660, Current, 0, 0, 6594);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(660, Current, 6594);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F661_12236 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 660, Current, 0, 0, 6595);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(660, Current, 6595);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F661_12242 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 660, Current, 0, 1, 6596);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(660, Current, 6596);
	RTIV(Current, RTAL);
...
void F661_12245 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 660, Current, 0, 1, 6591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(660, Current, 6591);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F661_12246 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 660, Current, 0, 0, 6592);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(660, Current, 6592);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F661_12247 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 660, Current, 2, 1, 6593);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(660, Current, 6593);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ui8_1 = ti8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9206, "extend", Result))(Result, ui8_1x);
		RTHOOK(9);
