...
extern EIF_TYPED_VALUE F680_12498(EIF_REFERENCE);
extern EIF_TYPED_VALUE F680_12499(EIF_REFERENCE);
extern void F680_12505(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F680_12508(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F680_12509(EIF_REFERENCE);
extern EIF_TYPED_VALUE F680_12510(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F680_12498 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 679, Current, 0, 0, 6876);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(679, Current, 6876);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F680_12499 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 679, Current, 0, 0, 6877);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(679, Current, 6877);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F680_12505 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 679, Current, 0, 1, 6878);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(679, Current, 6878);
	RTIV(Current, RTAL);
...
void F680_12508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 679, Current, 0, 1, 6879);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(679, Current, 6879);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F680_12509 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 679, Current, 0, 0, 6880);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(679, Current, 6880);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F680_12510 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 679, Current, 2, 1, 6881);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(679, Current, 6881);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ui1_1 = ti1_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9244, "extend", Result))(Result, ui1_1x);
		RTHOOK(9);
