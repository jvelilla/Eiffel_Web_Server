...
extern void F689_11822(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F689_11823(EIF_REFERENCE);
extern EIF_TYPED_VALUE F689_11824(EIF_REFERENCE);
extern EIF_TYPED_VALUE F689_11825(EIF_REFERENCE);
extern void F689_23511(EIF_REFERENCE, int);
...
void F689_11822 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 688, Current, 0, 3, 4668);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(688, Current, 4668);
	RTCC(arg1, 688, l_feature_name, 1, RTWCT(11002, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 11002, 0xF80002AE, 0); /* active */
...
EIF_TYPED_VALUE F689_11823 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F689_11824 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F689_11825 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F689_23511 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 688, Current, 0, 23510);
	RTSA(dtype);
	RTME(dtype, 0);
