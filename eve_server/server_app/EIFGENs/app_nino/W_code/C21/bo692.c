...
extern EIF_TYPED_VALUE F692_10052(EIF_REFERENCE);
extern void F692_23494(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F692_10052 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 691, Current, 0, 0, 3236);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(691, Current, 3236);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F692_23494 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 691, Current, 0, 23493);
	RTSA(dtype);
	RTME(dtype, 0);
