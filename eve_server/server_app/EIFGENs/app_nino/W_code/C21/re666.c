...
extern EIF_TYPED_VALUE F666_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F666_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 665, Current, 0, 0, 5529);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(665, Current, 5529);
	RTIV(Current, RTAL);
	RTHOOK(1);
