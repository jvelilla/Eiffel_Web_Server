...
extern EIF_TYPED_VALUE F685_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F685_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 684, Current, 0, 0, 5345);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(684, Current, 5345);
	RTIV(Current, RTAL);
	RTHOOK(1);
