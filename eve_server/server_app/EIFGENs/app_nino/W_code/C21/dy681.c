...
extern EIF_TYPED_VALUE F681_12372(EIF_REFERENCE);
extern EIF_TYPED_VALUE F681_12373(EIF_REFERENCE);
extern void F681_12379(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F681_12382(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F681_12383(EIF_REFERENCE);
extern EIF_TYPED_VALUE F681_12384(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F681_12372 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 680, Current, 0, 0, 6750);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(680, Current, 6750);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F681_12373 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 680, Current, 0, 0, 6751);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(680, Current, 6751);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F681_12379 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 680, Current, 0, 1, 6752);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(680, Current, 6752);
	RTIV(Current, RTAL);
...
void F681_12382 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 680, Current, 0, 1, 6753);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(680, Current, 6753);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F681_12383 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 680, Current, 0, 0, 6754);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(680, Current, 6754);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F681_12384 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 680, Current, 2, 1, 6755);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(680, Current, 6755);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(3);
	RTDBGAL(Current, 0, 0xF80002A8, 0,0); /* Result */
	...
	for (;;) {
		...
		uu4_1 = tu4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9201, "extend", Result))(Result, uu4_1x);
		RTHOOK(9);
