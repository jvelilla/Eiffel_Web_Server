...
extern EIF_TYPED_VALUE F671_9592(EIF_REFERENCE);
extern EIF_TYPED_VALUE F671_9593(EIF_REFERENCE);
extern EIF_TYPED_VALUE F671_9594(EIF_REFERENCE);
extern void F671_9595(EIF_REFERENCE);
extern void F671_9596(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F671_9592 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 670, Current, 0, 0, 2744);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(670, Current, 2744);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F671_9593 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F671_9594 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 670, Current, 0, 0, 2746);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(670, Current, 2746);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F671_9595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 670, Current, 0, 0, 2747);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(670, Current, 2747);
	RTIV(Current, RTAL);
...
void F671_9596 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 670, Current, 0, 0, 2748);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(670, Current, 2748);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
