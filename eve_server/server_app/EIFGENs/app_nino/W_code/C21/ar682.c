...
extern void F682_12772(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F682_12773(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F682_12774(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F682_12775(EIF_REFERENCE);
extern EIF_TYPED_VALUE F682_12776(EIF_REFERENCE);
...
void F682_12772 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 681, Current, 0, 1, 8031);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8031);
	RTCC(arg1, 681, l_feature_name, 1, RTWCT(9256, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11589, dtype))(Current, ur1x);
	RTHOOK(3);
...
/* {ARRAYED_STACK}.put */
void F682_12773 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 681, Current, 0, 1, 8032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8032);
	RTCC(arg1, 681, l_feature_name, 1, RTWCT(9256, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {ARRAYED_STACK}.force */
void F682_12774 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 681, Current, 0, 1, 8033);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8033);
	RTCC(arg1, 681, l_feature_name, 1, RTWCT(9256, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F682_12775 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 8034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8034);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F682_12776 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 681, Current, 1, 0, 8035);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8035);
	RTIV(Current, RTAL);
	RTHOOK(1);
