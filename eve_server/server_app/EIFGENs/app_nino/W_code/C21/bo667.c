...
extern EIF_TYPED_VALUE F667_9605(EIF_REFERENCE);
extern void F667_22873(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F667_9605 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 666, Current, 0, 0, 2838);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(666, Current, 2838);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F667_22873 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 666, Current, 0, 22872);
	RTSA(dtype);
	RTME(dtype, 0);
