...
extern EIF_TYPED_VALUE F910_10052(EIF_REFERENCE);
extern void F910_23494(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F910_10052 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 909, Current, 0, 0, 3246);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {BOUNDED}._invariant */
void F910_23494 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 909, Current, 0, 23493);
	RTSA(dtype);
	RTME(dtype, 0);
