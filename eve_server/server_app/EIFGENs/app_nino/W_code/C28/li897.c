...
extern EIF_TYPED_VALUE F897_13015(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F897_13016(EIF_REFERENCE);
extern EIF_TYPED_VALUE F897_13017(EIF_REFERENCE);
extern void F897_23529(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F897_13015 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 896, Current, 2, 1, 7408);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(896, Current, 7408);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						ti2_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9658, "item", arg1))(arg1)).it_i2);
...
/* {LIST}.after */
EIF_TYPED_VALUE F897_13016 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 896, Current, 0, 0, 7409);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(896, Current, 7409);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F897_13017 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 896, Current, 0, 0, 7410);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(896, Current, 7410);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F897_23529 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 896, Current, 0, 23528);
	RTSA(dtype);
	RTME(dtype, 0);
