...
extern EIF_TYPED_VALUE F918_9566(EIF_REFERENCE);
extern void F918_22748(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F918_9566 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 917, Current, 0, 0, 2792);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(917, Current, 2792);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F918_22748 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 917, Current, 0, 22747);
	RTSA(dtype);
	RTME(dtype, 0);
