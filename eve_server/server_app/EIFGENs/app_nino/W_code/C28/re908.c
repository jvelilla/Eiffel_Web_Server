...
extern EIF_TYPED_VALUE F908_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F908_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 907, Current, 0, 0, 5535);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(907, Current, 5535);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800038C, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {908,0,0xFFFF};
