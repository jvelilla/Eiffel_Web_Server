...
extern EIF_TYPED_VALUE F902_12308(EIF_REFERENCE);
...
EIF_TYPED_VALUE F902_12308 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 901, Current, 0, 0, 5542);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(901, Current, 5542);
	RTIV(Current, RTAL);
	RTHOOK(1);
