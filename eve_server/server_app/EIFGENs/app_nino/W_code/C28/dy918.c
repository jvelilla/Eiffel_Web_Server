...
extern void F918_12650(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F918_12652(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F918_12653(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F918_12657(EIF_REFERENCE);
...
void F918_12650 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 917, Current, 1, 1, 7040);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(917, Current, 7040);
	RTIV(Current, RTAL);
...
void F918_12652 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 917, Current, 0, 1, 7041);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(917, Current, 7041);
...
body:;
	...
	for (;;) {
		...
		uu1_1 = tu1_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11515, dtype))(Current, uu1_1x);
		RTHOOK(8);
...
void F918_12653 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 917, Current, 0, 1, 7042);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(917, Current, 7042);
	RTCC(arg1, 917, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F918_12657 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 917, Current, 0, 0, 7043);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(917, Current, 7043);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
