...
extern EIF_TYPED_VALUE F904_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F904_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 903, Current, 0, 0, 5350);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(903, Current, 5350);
	RTIV(Current, RTAL);
	RTHOOK(1);
