...
extern EIF_TYPED_VALUE F909_9572(EIF_REFERENCE);
extern EIF_TYPED_VALUE F909_9573(EIF_REFERENCE);
extern EIF_TYPED_VALUE F909_9574(EIF_REFERENCE);
extern void F909_9575(EIF_REFERENCE);
extern void F909_22750(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F909_9572 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F909_9573 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 908, Current, 0, 0, 2899);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(908, Current, 2899);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F909_9574 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 908, Current, 0, 0, 2900);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(908, Current, 2900);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F909_9575 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 908, Current, 0, 0, 2901);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(908, Current, 2901);
	RTIV(Current, RTAL);
...
void F909_22750 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 908, Current, 0, 22749);
	RTSA(dtype);
	RTME(dtype, 0);
