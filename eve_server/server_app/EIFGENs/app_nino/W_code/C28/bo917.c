...
extern EIF_TYPED_VALUE F917_9568(EIF_REFERENCE);
extern void F917_22749(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F917_9568 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 916, Current, 0, 0, 2822);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(916, Current, 2822);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F917_22749 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 916, Current, 0, 22748);
	RTSA(dtype);
	RTME(dtype, 0);
