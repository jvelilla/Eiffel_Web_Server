...
extern EIF_TYPED_VALUE F897_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F897_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 896, Current, 0, 0, 5416);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(896, Current, 5416);
	RTIV(Current, RTAL);
	RTHOOK(1);
