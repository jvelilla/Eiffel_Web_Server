...
extern EIF_TYPED_VALUE F893_12506(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F893_12507(EIF_REFERENCE);
extern EIF_TYPED_VALUE F893_12508(EIF_REFERENCE);
extern void F893_22964(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F893_12506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 892, Current, 2, 1, 6969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 6969);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu2_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9252, "item", arg1))(arg1)).it_n2);
...
/* {LIST}.after */
EIF_TYPED_VALUE F893_12507 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 892, Current, 0, 0, 6970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 6970);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F893_12508 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 892, Current, 0, 0, 6971);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(892, Current, 6971);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F893_22964 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 892, Current, 0, 22963);
	RTSA(dtype);
	RTME(dtype, 0);
