...
extern EIF_TYPED_VALUE F908_12235(EIF_REFERENCE);
extern EIF_TYPED_VALUE F908_12236(EIF_REFERENCE);
extern void F908_12242(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F908_12245(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F908_12246(EIF_REFERENCE);
extern EIF_TYPED_VALUE F908_12247(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F908_12235 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 907, Current, 0, 0, 6630);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F908_12236 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 907, Current, 0, 0, 6631);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
/* {DYNAMIC_CHAIN}.prune */
void F908_12242 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 907, Current, 0, 1, 6632);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F908_12245 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 907, Current, 0, 1, 6627);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F908_12246 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F908_12247 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 907, Current, 2, 1, 6629);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	for (;;) {
		...
		ui2_1 = ti2_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9206, "extend", Result))(Result, ui2_1x);
		RTHOOK(9);
