...
extern EIF_TYPED_VALUE F922_12372(EIF_REFERENCE);
extern EIF_TYPED_VALUE F922_12373(EIF_REFERENCE);
extern void F922_12379(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F922_12382(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F922_12383(EIF_REFERENCE);
extern EIF_TYPED_VALUE F922_12384(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F922_12372 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 921, Current, 0, 0, 6786);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(921, Current, 6786);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F922_12373 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 921, Current, 0, 0, 6787);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(921, Current, 6787);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F922_12379 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 921, Current, 0, 1, 6788);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 6788);
	RTIV(Current, RTAL);
...
void F922_12382 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 921, Current, 0, 1, 6789);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 6789);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F922_12383 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 921, Current, 0, 0, 6790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 6790);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F922_12384 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 921, Current, 2, 1, 6791);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 6791);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ui2_1 = ti2_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9201, "extend", Result))(Result, ui2_1x);
		RTHOOK(9);
