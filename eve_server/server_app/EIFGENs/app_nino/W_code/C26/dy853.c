...
extern EIF_TYPED_VALUE F853_13000(EIF_REFERENCE);
extern EIF_TYPED_VALUE F853_13001(EIF_REFERENCE);
extern void F853_13007(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F853_13010(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F853_13011(EIF_REFERENCE);
extern EIF_TYPED_VALUE F853_13012(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F853_13000 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 852, Current, 0, 0, 7329);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(852, Current, 7329);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F853_13001 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 852, Current, 0, 0, 7330);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(852, Current, 7330);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F853_13007 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 852, Current, 0, 1, 7331);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(852, Current, 7331);
	RTIV(Current, RTAL);
...
void F853_13010 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 852, Current, 0, 1, 7332);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(852, Current, 7332);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F853_13011 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 852, Current, 0, 0, 7333);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(852, Current, 7333);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F853_13012 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 852, Current, 2, 1, 7334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(852, Current, 7334);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uu1_1 = tu1_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9646, "extend", Result))(Result, uu1_1x);
		RTHOOK(9);
