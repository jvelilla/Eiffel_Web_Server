...
extern EIF_TYPED_VALUE F825_12138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F825_12138 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 824, Current, 0, 0, 5348);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(824, Current, 5348);
	RTIV(Current, RTAL);
	RTHOOK(1);
