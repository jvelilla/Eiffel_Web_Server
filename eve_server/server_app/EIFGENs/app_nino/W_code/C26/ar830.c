...
extern void F830_12509(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F830_12510(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F830_12511(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F830_12512(EIF_REFERENCE);
extern EIF_TYPED_VALUE F830_12513(EIF_REFERENCE);
...
void F830_12509 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 829, Current, 0, 1, 7746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 7746);
	RTCC(arg1, 829, l_feature_name, 1, RTWCT(9218, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11327, dtype))(Current, ur1x);
	RTHOOK(3);
...
/* {ARRAYED_STACK}.put */
void F830_12510 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 829, Current, 0, 1, 7747);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 7747);
	RTCC(arg1, 829, l_feature_name, 1, RTWCT(9218, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {ARRAYED_STACK}.force */
void F830_12511 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 829, Current, 0, 1, 7748);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 7748);
	RTCC(arg1, 829, l_feature_name, 1, RTWCT(9218, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F830_12512 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 829, Current, 0, 0, 7749);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 7749);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F830_12513 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 829, Current, 1, 0, 7750);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 7750);
	RTIV(Current, RTAL);
	RTHOOK(1);
