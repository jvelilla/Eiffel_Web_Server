...
extern void F852_13152(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F852_13154(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F852_13155(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F852_13159(EIF_REFERENCE);
...
void F852_13152 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 851, Current, 1, 1, 7463);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(851, Current, 7463);
	RTIV(Current, RTAL);
...
void F852_13154 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 851, Current, 0, 1, 7464);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(851, Current, 7464);
	RTCC(arg1, 851, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
body:;
	...
	for (;;) {
		...
		uu1_1 = tu1_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(11978, dtype))(Current, uu1_1x);
		RTHOOK(8);
...
void F852_13155 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 851, Current, 0, 1, 7465);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(851, Current, 7465);
	RTCC(arg1, 851, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F852_13159 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 851, Current, 0, 0, 7466);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(851, Current, 7466);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
