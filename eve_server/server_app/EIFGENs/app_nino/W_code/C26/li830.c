...
extern EIF_TYPED_VALUE F830_12513(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F830_12514(EIF_REFERENCE);
extern EIF_TYPED_VALUE F830_12515(EIF_REFERENCE);
extern void F830_22971(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F830_12513 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 829, Current, 2, 1, 6973);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 6973);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9256, "item", arg1))(arg1)).it_c1);
...
/* {LIST}.after */
EIF_TYPED_VALUE F830_12514 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 829, Current, 0, 0, 6974);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 6974);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F830_12515 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 829, Current, 0, 0, 6975);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(829, Current, 6975);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F830_22971 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 829, Current, 0, 22970);
	RTSA(dtype);
	RTME(dtype, 0);
