...
extern EIF_TYPED_VALUE F833_9598(EIF_REFERENCE);
extern void F833_22751(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F833_9598 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 832, Current, 0, 0, 3001);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(832, Current, 3001);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F833_22751 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 832, Current, 0, 22750);
	RTSA(dtype);
	RTME(dtype, 0);
