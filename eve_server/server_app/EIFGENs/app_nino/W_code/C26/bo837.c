...
extern EIF_TYPED_VALUE F837_9605(EIF_REFERENCE);
extern void F837_22873(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F837_9605 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 836, Current, 0, 0, 2846);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(836, Current, 2846);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F837_22873 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 836, Current, 0, 22872);
	RTSA(dtype);
	RTME(dtype, 0);
