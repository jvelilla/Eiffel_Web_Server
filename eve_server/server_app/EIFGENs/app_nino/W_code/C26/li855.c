...
extern EIF_TYPED_VALUE F855_10340(EIF_REFERENCE);
extern void F855_10341(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F855_10342(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F855_10340 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F855_10341 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 854, Current, 0, 1, 3547);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(854, Current, 3547);
	RTCC(arg1, 854, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9641, 0xF8000356, 0); /* right */
...
void F855_10342 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 854, Current, 0, 0, 3548);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(854, Current, 3548);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9641, 0xF8000356, 0); /* right */
