...
extern EIF_TYPED_VALUE F841_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F841_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 840, Current, 0, 0, 5414);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(840, Current, 5414);
	RTIV(Current, RTAL);
	RTHOOK(1);
