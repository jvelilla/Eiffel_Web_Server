...
extern EIF_TYPED_VALUE F832_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F832_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 831, Current, 0, 0, 5974);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(831, Current, 5974);
	RTIV(Current, RTAL);
	RTHOOK(1);
