...
extern void F846_10169(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F846_10170(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F846_10171(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F846_10172(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F846_23498(EIF_REFERENCE, int);
...
/* {TRAVERSABLE}.do_if */
void F846_10170 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 845, Current, 0, 2, 3494);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(845, Current, 3494);
	if (arg1) {
		{
			EIF_TYPE_INDEX typarr0[] = {502,0,0xFFF9,1,368,0,0xFFFF};
			EIF_TYPE_INDEX typres0;
	...
	if (arg2) {
		{
			...
			typres0 = eif_compound_id(Dftype(Current), typarr0);
			RTCC(arg2, 845, l_feature_name, 2, typres0);
		}
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
...
EIF_TYPED_VALUE F846_10171 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 845, Current, 0, 1, 3495);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(845, Current, 3495);
	if (arg1) {
		{
			EIF_TYPE_INDEX typarr0[] = {500,0,0xFFF9,1,368,0,376,0xFFFF};
			EIF_TYPE_INDEX typres0;
...
void F846_23498 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 845, Current, 0, 23497);
	RTSA(dtype);
	RTME(dtype, 0);
