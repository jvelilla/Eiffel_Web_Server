...
extern EIF_TYPED_VALUE F838_9568(EIF_REFERENCE);
extern void F838_22749(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F838_9568 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 837, Current, 0, 0, 2818);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(837, Current, 2818);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F838_22749 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 837, Current, 0, 22748);
	RTSA(dtype);
	RTME(dtype, 0);
