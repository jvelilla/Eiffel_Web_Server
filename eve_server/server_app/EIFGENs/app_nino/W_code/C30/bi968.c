...
extern EIF_TYPED_VALUE F968_9866(EIF_REFERENCE);
extern void F968_9869(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F968_22755(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F968_9866 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 967, Current, 0, 0, 3333);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(967, Current, 3333);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F968_9869 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 967, Current, 0, 1, 3334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(967, Current, 3334);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9348, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	ui2_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9350, dtype))(Current, ui2_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F968_22755 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 967, Current, 0, 22754);
	RTSA(dtype);
	RTME(dtype, 0);
