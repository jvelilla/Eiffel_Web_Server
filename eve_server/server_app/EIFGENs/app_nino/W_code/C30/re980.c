...
extern EIF_TYPED_VALUE F980_12308(EIF_REFERENCE);
...
EIF_TYPED_VALUE F980_12308 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 5544);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(979, Current, 5544);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80003D4, 0,0); /* Result */
	
	{
		EIF_TYPE_INDEX typarr0[] = {980,0,0xFFFF};
