...
extern void F977_11346(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F977_11347(EIF_REFERENCE);
extern EIF_TYPED_VALUE F977_11348(EIF_REFERENCE);
extern EIF_TYPED_VALUE F977_11349(EIF_REFERENCE);
extern void F977_22946(EIF_REFERENCE, int);
...
void F977_11346 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 976, Current, 0, 3, 4259);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(976, Current, 4259);
	RTCC(arg1, 976, l_feature_name, 1, RTWCT(10564, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10564, 0xF80003D1, 0); /* active */
...
EIF_TYPED_VALUE F977_11347 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F977_11348 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F977_11349 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F977_22946 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 976, Current, 0, 22945);
	RTSA(dtype);
	RTME(dtype, 0);
