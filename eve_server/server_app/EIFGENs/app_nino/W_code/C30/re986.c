...
extern EIF_TYPED_VALUE F986_12301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F986_12301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 5537);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 5537);
	RTIV(Current, RTAL);
	RTHOOK(1);
