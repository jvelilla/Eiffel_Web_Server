...
extern EIF_TYPED_VALUE F971_10348(EIF_REFERENCE);
extern void F971_10349(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F971_10350(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F971_10348 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F971_10349 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 970, Current, 0, 1, 3578);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(970, Current, 3578);
	RTCC(arg1, 970, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9655, 0xF80003CA, 0); /* right */
...
void F971_10350 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 3579);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(970, Current, 3579);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9655, 0xF80003CA, 0); /* right */
