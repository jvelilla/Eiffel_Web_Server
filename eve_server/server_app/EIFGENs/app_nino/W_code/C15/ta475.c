...
extern void F475_9610(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F475_9610 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 474, Current, 0, 1, 2983);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(474, Current, 2983);
	RTCC(arg1, 474, l_feature_name, 1, RTWCT(9190, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
