...
extern EIF_TYPED_VALUE F494_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F494_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 493, Current, 0, 0, 5966);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(493, Current, 5966);
	RTIV(Current, RTAL);
	RTHOOK(1);
