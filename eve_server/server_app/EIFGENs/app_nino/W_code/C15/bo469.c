...
extern EIF_TYPED_VALUE F469_9568(EIF_REFERENCE);
extern void F469_22749(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F469_9568 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 468, Current, 0, 0, 2800);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(468, Current, 2800);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F469_22749 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 468, Current, 0, 22748);
	RTSA(dtype);
	RTME(dtype, 0);
