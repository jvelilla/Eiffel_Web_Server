...
extern EIF_TYPED_VALUE F485_10340(EIF_REFERENCE);
extern void F485_10341(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F485_10342(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F485_10340 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F485_10341 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 484, Current, 0, 1, 3544);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(484, Current, 3544);
	RTCC(arg1, 484, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9641, 0xF80001E4, 0); /* right */
...
void F485_10342 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 484, Current, 0, 0, 3545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(484, Current, 3545);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9641, 0xF80001E4, 0); /* right */
