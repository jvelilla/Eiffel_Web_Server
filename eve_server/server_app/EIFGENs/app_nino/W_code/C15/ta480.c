...
extern void F480_9594(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F480_9594 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 479, Current, 0, 1, 2965);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(479, Current, 2965);
	RTCC(arg1, 479, l_feature_name, 1, RTWCT(9177, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
