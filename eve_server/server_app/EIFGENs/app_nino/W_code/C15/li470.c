...
extern EIF_TYPED_VALUE F470_12250(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F470_12251(EIF_REFERENCE);
extern EIF_TYPED_VALUE F470_12252(EIF_REFERENCE);
extern void F470_22690(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F470_12250 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 469, Current, 2, 1, 6651);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(469, Current, 6651);
	RTCC(arg1, 469, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr4 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9218, "item", arg1))(arg1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
/* {LIST}.after */
EIF_TYPED_VALUE F470_12251 (EIF_REFERENCE Current)
{
	GTCX
...
/* {LIST}.before */
EIF_TYPED_VALUE F470_12252 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 469, Current, 0, 0, 6653);
	RTSA(Dtype(Current));
	RTSC;
...
/* {LIST}._invariant */
void F470_22690 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 469, Current, 0, 22689);
	RTSA(dtype);
	RTME(dtype, 0);
