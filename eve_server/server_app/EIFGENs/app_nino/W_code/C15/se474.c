...
extern EIF_TYPED_VALUE F474_9905(EIF_REFERENCE);
extern EIF_TYPED_VALUE F474_9906(EIF_REFERENCE);
extern void F474_9907(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F474_9908(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F474_9909(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F474_9910(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F474_9911(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SEQUENCE}.readable */
EIF_TYPED_VALUE F474_9905 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 473, Current, 0, 0, 3341);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(473, Current, 3341);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SEQUENCE}.writable */
EIF_TYPED_VALUE F474_9906 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 473, Current, 0, 0, 3342);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(473, Current, 3342);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {SEQUENCE}.force */
void F474_9907 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 473, Current, 0, 1, 3343);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(473, Current, 3343);
	RTCC(arg1, 473, l_feature_name, 1, RTWCT(9205, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F474_9908 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 473, Current, 1, 1, 3344);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(473, Current, 3344);
	if (arg1) {
		{
			...
			RTCC(arg1, 473, l_feature_name, 1, typres0);
		}
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
...
/* {SEQUENCE}.put */
void F474_9909 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 473, Current, 0, 1, 3345);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(473, Current, 3345);
	RTCC(arg1, 473, l_feature_name, 1, RTWCT(9205, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune */
void F474_9910 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 473, Current, 0, 1, 3346);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(473, Current, 3346);
	RTCC(arg1, 473, l_feature_name, 1, RTWCT(9205, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune_all */
void F474_9911 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 473, Current, 0, 1, 3347);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(473, Current, 3347);
	RTCC(arg1, 473, l_feature_name, 1, RTWCT(9205, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
