...
extern EIF_TYPED_VALUE F468_9606(EIF_REFERENCE);
extern void F468_22812(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F468_9606 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 467, Current, 0, 0, 2992);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(467, Current, 2992);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F468_22812 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 467, Current, 0, 22811);
	RTSA(dtype);
	RTME(dtype, 0);
