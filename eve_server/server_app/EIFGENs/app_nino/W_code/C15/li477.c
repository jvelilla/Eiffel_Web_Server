...
extern EIF_TYPED_VALUE F477_12343(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F477_12344(EIF_REFERENCE);
extern EIF_TYPED_VALUE F477_12345(EIF_REFERENCE);
extern void F477_22783(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F477_12343 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 476, Current, 2, 1, 6744);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(476, Current, 6744);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr4 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9205, "item", arg1))(arg1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
/* {LIST}.after */
EIF_TYPED_VALUE F477_12344 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 476, Current, 0, 0, 6745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(476, Current, 6745);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F477_12345 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 476, Current, 0, 0, 6746);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(476, Current, 6746);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F477_22783 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 476, Current, 0, 22782);
	RTSA(dtype);
	RTME(dtype, 0);
