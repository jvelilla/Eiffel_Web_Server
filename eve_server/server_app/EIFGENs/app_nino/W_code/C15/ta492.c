...
extern void F492_9610(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F492_9610 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 491, Current, 0, 1, 2984);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(491, Current, 2984);
	RTCC(arg1, 491, l_feature_name, 1, RTWCT(9190, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
