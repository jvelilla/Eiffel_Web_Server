...
extern void F488_9631(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F488_9631 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 487, Current, 0, 1, 2992);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(487, Current, 2992);
	RTCC(arg1, 487, l_feature_name, 1, RTWCT(9214, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
