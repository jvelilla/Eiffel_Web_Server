...
extern EIF_TYPED_VALUE F485_12372(EIF_REFERENCE);
extern EIF_TYPED_VALUE F485_12373(EIF_REFERENCE);
extern void F485_12379(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F485_12382(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F485_12383(EIF_REFERENCE);
extern EIF_TYPED_VALUE F485_12384(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F485_12372 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 484, Current, 0, 0, 6720);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(484, Current, 6720);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F485_12373 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 484, Current, 0, 0, 6721);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(484, Current, 6721);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F485_12379 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 484, Current, 0, 1, 6722);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(484, Current, 6722);
	RTCC(arg1, 484, l_feature_name, 1, RTWCT(9213, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
void F485_12382 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 484, Current, 0, 1, 6723);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(484, Current, 6723);
	RTCC(arg1, 484, l_feature_name, 1, RTWCT(9213, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F485_12383 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 484, Current, 0, 0, 6724);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(484, Current, 6724);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F485_12384 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 484, Current, 2, 1, 6725);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(484, Current, 6725);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
