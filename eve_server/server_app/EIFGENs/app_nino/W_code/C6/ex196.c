...
extern EIF_TYPED_VALUE F196_9666(EIF_REFERENCE);
...
RTOID (F196_9666)
EIF_TYPED_VALUE F196_9666 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 195, Current, 0, 0, 2892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(195, Current, 2892);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
