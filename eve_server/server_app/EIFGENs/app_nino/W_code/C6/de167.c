...
extern EIF_TYPED_VALUE F167_9215(EIF_REFERENCE);
...
EIF_TYPED_VALUE F167_9215 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 166, Current, 0, 0, 2499);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8412, 148))(Current)).it_i4);
