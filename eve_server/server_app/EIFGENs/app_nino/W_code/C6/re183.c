...
extern EIF_TYPED_VALUE F183_9300(EIF_REFERENCE);
extern EIF_TYPED_VALUE F183_9301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F183_9300 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 182, Current, 0, 0, 2584);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(182, Current, 2584);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F183_9301)
EIF_TYPED_VALUE F183_9301 (EIF_REFERENCE Current)
{
	GTCX
