...
extern EIF_TYPED_VALUE F197_9326(EIF_REFERENCE);
extern EIF_TYPED_VALUE F197_9327(EIF_REFERENCE);
...
EIF_TYPED_VALUE F197_9326 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 196, Current, 0, 0, 2610);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(196, Current, 2610);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F197_9327)
EIF_TYPED_VALUE F197_9327 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 196, Current, 0, 0, 2611);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(196, Current, 2611);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
