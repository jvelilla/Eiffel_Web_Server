...
extern EIF_TYPED_VALUE F171_9230(EIF_REFERENCE);
...
RTOID (F171_9230)
EIF_TYPED_VALUE F171_9230 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 170, Current, 0, 0, 2514);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
