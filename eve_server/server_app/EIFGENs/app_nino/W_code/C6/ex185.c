...
extern EIF_TYPED_VALUE F185_9266(EIF_REFERENCE);
extern EIF_TYPED_VALUE F185_9267(EIF_REFERENCE);
...
EIF_TYPED_VALUE F185_9266 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 184, Current, 0, 0, 2550);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(184, Current, 2550);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F185_9267)
EIF_TYPED_VALUE F185_9267 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 184, Current, 0, 0, 2551);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(184, Current, 2551);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
