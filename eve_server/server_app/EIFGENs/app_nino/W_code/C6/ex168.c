...
extern EIF_TYPED_VALUE F168_9219(EIF_REFERENCE);
...
RTOID (F168_9219)
EIF_TYPED_VALUE F168_9219 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 167, Current, 0, 0, 2493);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(167, Current, 2493);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
