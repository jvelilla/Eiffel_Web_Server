...
extern EIF_TYPED_VALUE F182_9298(EIF_REFERENCE);
extern EIF_TYPED_VALUE F182_9299(EIF_REFERENCE);
...
EIF_TYPED_VALUE F182_9298 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 181, Current, 0, 0, 2582);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(181, Current, 2582);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F182_9299)
EIF_TYPED_VALUE F182_9299 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 181, Current, 0, 0, 2583);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(181, Current, 2583);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
