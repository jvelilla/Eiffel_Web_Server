...
extern EIF_TYPED_VALUE F190_9310(EIF_REFERENCE);
extern EIF_TYPED_VALUE F190_9311(EIF_REFERENCE);
...
EIF_TYPED_VALUE F190_9310 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 189, Current, 0, 0, 2594);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(189, Current, 2594);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F190_9311)
EIF_TYPED_VALUE F190_9311 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 189, Current, 0, 0, 2595);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(189, Current, 2595);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
