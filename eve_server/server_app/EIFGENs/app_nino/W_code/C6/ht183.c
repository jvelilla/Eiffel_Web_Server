/*
 * Code for class HTTP_REQUEST_HANDLER
 */
...
extern void F183_9406(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F183_9407(EIF_REFERENCE);
...
/* {HTTP_REQUEST_HANDLER}.set_client_socket */
void F183_9406 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
	char *l_feature_name = "set_client_socket";
	RTEX;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 182, Current, 1, 1, 2702);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(182, Current, 2702);
	if (arg1) {
		RTCC(arg1, 182, l_feature_name, 1, 34);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4029, "is_closed", arg1))(arg1)).it_b);
...
body:;
	...
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(9051, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		RTCT(NULL, EX_POST);
		tb1 = '\01';
		...
		loc1 = RTCCL(tr1);
		if (EIF_TEST(loc1)) {
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4022, "descriptor", loc1))(loc1)).it_i4);
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4022, "descriptor", arg1))(arg1)).it_i4);
