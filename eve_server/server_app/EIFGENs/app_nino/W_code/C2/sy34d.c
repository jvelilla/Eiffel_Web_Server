...
static EIF_TYPE_INDEX gen_type0_34 [] = {441,33,0xFFFF};
...
static struct desc_info desc_34[] = {
	{(BODY_INDEX) 606, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 341, NULL},
	{1, (BODY_INDEX)-1, 441, gen_type0_34},
