...
#define ur1 ur1x.it_r
	...
	if (arg1) {
		RTCC(arg1, 47, l_feature_name, 1, 287);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		ur1 = RTCCL(tr1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6383, Dtype(Current)))(Current, ur1x);
		RTHOOK(3);
...
#define ur1 ur1x.it_r
	...
	if (arg1) {
		RTCC(arg1, 47, l_feature_name, 1, 363);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6384, Dtype(Current)))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define ur1 ur1x.it_r
	...
	if (arg1) {
		RTCC(arg1, 47, l_feature_name, 1, 371);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6385, Dtype(Current)))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define ur1 ur1x.it_r
	...
	if (arg1) {
		RTCC(arg1, 47, l_feature_name, 1, 239);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	loc1 = RTCCL(arg1);
	loc1 = RTRV(eif_non_attached_type(240),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(2);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10312, "router", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6382, Dtype(Current)))(Current, ur1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
