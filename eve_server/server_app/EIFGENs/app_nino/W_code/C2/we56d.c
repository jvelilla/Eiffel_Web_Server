...
static EIF_TYPE_INDEX gen_type0_56 [] = {490,55,0xFFFF};
static EIF_TYPE_INDEX gen_type1_56 [] = {0,0xFFFF};
static EIF_TYPE_INDEX gen_type2_56 [] = {0,0xFFFF};
...
static struct desc_info desc_56[] = {
	...
	{1, (BODY_INDEX)-1, 490, gen_type0_56},
