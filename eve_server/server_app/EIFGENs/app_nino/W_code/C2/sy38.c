...
extern void F38_22852(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F38_4096 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 37, Current, 0, 0, 646);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(37, Current, 646);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F38_22852 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 37, Current, 0, 22851);
	RTSA(Dtype(Current));
	RTME(Dtype(Current), 0);
