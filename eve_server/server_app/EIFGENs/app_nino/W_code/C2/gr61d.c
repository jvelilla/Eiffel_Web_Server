...
static EIF_TYPE_INDEX gen_type0_61 [] = {454,60,0xFFFF};
...
static struct desc_info desc_61[] = {
	{(BODY_INDEX) 1078, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 354, NULL},
	{1, (BODY_INDEX)-1, 454, gen_type0_61},
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 60, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 60, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 60, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 60, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 60, NULL},
