...
extern EIF_TYPED_VALUE F37_4073(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_4074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_4075(EIF_REFERENCE);
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F37_4069);
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 645);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4071, Dtype(Current)))(Current)).it_c1);
	RTVI(Current, RTAL);
	RTRS;
	RTOTE;
	RTHOOK(2);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 646);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(36, Current, 646);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800015A, 0,0); /* Result */
	
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4072, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTVI(Current, RTAL);
	RTRS;
	RTOTE;
	RTHOOK(2);
...
EIF_TYPED_VALUE F37_4071 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 647);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(36, Current, 647);
...
EIF_TYPED_VALUE F37_4072 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 648);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(36, Current, 648);
...
EIF_TYPED_VALUE F37_4073 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 649);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(36, Current, 649);
...
EIF_TYPED_VALUE F37_4074 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 650);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(36, Current, 650);
...
EIF_TYPED_VALUE F37_4075 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 651);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(36, Current, 651);
