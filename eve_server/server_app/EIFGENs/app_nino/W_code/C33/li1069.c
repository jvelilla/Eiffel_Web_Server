...
extern EIF_TYPED_VALUE F1069_10351(EIF_REFERENCE);
extern void F1069_10352(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1069_10353(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F1069_10351 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F1069_10352 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1068, Current, 0, 1, 3584);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1068, Current, 3584);
	RTCC(arg1, 1068, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9655, 0xF800042C, 0); /* right */
...
void F1069_10353 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1068, Current, 0, 0, 3585);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1068, Current, 3585);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9655, 0xF800042C, 0); /* right */
