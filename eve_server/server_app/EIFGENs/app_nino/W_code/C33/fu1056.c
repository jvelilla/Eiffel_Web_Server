...
extern EIF_TYPED_VALUE F1056_17567(EIF_REFERENCE);
extern void F1056_17568(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1056_17569(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1056_17570(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1056_17571(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1056_17572(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1056_17573(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1056_17574(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1056_17575(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1056_17576(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
#ifndef INLINE_F1056_17576
static EIF_INTEGER_8 inline_F1056_17576 (EIF_POINTER arg1, EIF_POINTER arg2, EIF_POINTER arg3, EIF_POINTER arg4, EIF_INTEGER_32 arg5, EIF_BOOLEAN arg6, EIF_INTEGER_32 arg7, EIF_INTEGER_32 arg8, EIF_INTEGER_32 arg9, EIF_POINTER arg10)
{
	#ifdef WORKBENCH
...
EIF_TYPED_VALUE F1056_17567 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT8;
	r.it_i1 = *(EIF_INTEGER_8 *)(Current + RTWA(15563,Dtype(Current)));
	return r;
}
...
body:;
	...
	up7 = tr2;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(15568, dtype))(Current, up1x, up2x, up4x, up5x, ui4_1x, ub1x, ui4_2x, ui4_3x, ui4_4x, up7x)).it_i1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
	RTDBGLE;
...
/* {FUNCTION}.is_equal */
EIF_TYPED_VALUE F1056_17571 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1055, Current, 0, 1, 10817);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 10817);
...
body:;
	...
	if (tb2) {
		ti1_1 = *(EIF_INTEGER_8 *)(Current + RTWA(15563, dtype));
		ti1_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15563, "last_result", arg1))(arg1)).it_i1);
		tb1 = (ti1_1 == ti1_2);
	}
...
/* {FUNCTION}.copy */
void F1056_17572 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1055, Current, 0, 1, 10818);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 10818);
	RTCC(arg1, 1055, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if (!RTCEQ(arg1, Current)) {
		...
		ti1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15563, "last_result", arg1))(arg1)).it_i1);
		*(EIF_INTEGER_8 *)(Current + RTWA(15563, dtype)) = (EIF_INTEGER_8) ti1_1;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(6);
...
/* {FUNCTION}.eval */
EIF_TYPED_VALUE F1056_17573 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1055, Current, 0, 1, 10819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 10819);
	RTCC(arg1, 1055, l_feature_name, 1, RTWCT(15561, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	ur1 = RTCCL(arg1);
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(15564, dtype))(Current, ur1x)).it_i1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
void F1056_17574 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1055, Current, 1, 0, 10820);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1055, Current, 10820);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 15563, 0x0C000000, 0); /* last_result */
	
	*(EIF_INTEGER_8 *)(Current + RTWA(15563, Dtype(Current))) = (EIF_INTEGER_8) loc1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1056_17575 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1055, Current, 2, 1, 10821);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 10821);
	if (arg1) {
		{
			...
			RTCC(arg1, 1055, l_feature_name, 1, typres0);
		}
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
...
/* {FUNCTION}.fast_item */
EIF_TYPED_VALUE F1056_17576 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x, EIF_TYPED_VALUE arg6x, EIF_TYPED_VALUE arg7x, EIF_TYPED_VALUE arg8x, EIF_TYPED_VALUE arg9x, EIF_TYPED_VALUE arg10x)
{
	GTCX
...
#define arg10 arg10x.it_p
	...
	RTEAA(l_feature_name, 1055, Current, 0, 10, 10822);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1055, Current, 10822);
	RTIV(Current, RTAL);
	Result = inline_F1056_17576 ((EIF_POINTER) arg1, (EIF_POINTER) arg2, (EIF_POINTER) arg3, (EIF_POINTER) arg4, (EIF_INTEGER_32) arg5, (EIF_BOOLEAN) arg6, (EIF_INTEGER_32) arg7, (EIF_INTEGER_32) arg8, (EIF_INTEGER_32) arg9, (EIF_POINTER) arg10);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
