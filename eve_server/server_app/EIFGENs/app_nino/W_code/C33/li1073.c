...
extern void F1073_10349(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1073_10350(EIF_REFERENCE);
...
/* {LINKABLE}.put_right */
void F1073_10349 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1072, Current, 0, 1, 3581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1072, Current, 3581);
	RTCC(arg1, 1072, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9655, 0xF8000430, 0); /* right */
...
void F1073_10350 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1072, Current, 0, 0, 3582);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1072, Current, 3582);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9655, 0xF8000430, 0); /* right */
