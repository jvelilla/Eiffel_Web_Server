...
extern EIF_TYPED_VALUE F1056_12328(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1056_12329(EIF_REFERENCE);
extern void F1056_12335(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1056_12338(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1056_12339(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1056_12340(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1056_12328 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1055, Current, 0, 0, 6741);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1055, Current, 6741);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1056_12329 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1055, Current, 0, 0, 6742);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1055, Current, 6742);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F1056_12335 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 1055, Current, 0, 1, 6743);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 6743);
	RTIV(Current, RTAL);
...
void F1056_12338 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 1055, Current, 0, 1, 6738);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 6738);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F1056_12339 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1055, Current, 0, 0, 6739);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 6739);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F1056_12340 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 1055, Current, 2, 1, 6740);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 6740);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uu2_1 = tu2_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9193, "extend", Result))(Result, uu2_1x);
		RTHOOK(9);
