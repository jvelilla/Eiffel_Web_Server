...
extern EIF_TYPED_VALUE F1059_10340(EIF_REFERENCE);
extern void F1059_10341(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1059_10342(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F1059_10340 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F1059_10341 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1058, Current, 0, 1, 3553);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1058, Current, 3553);
	RTCC(arg1, 1058, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9641, 0xF8000422, 0); /* right */
...
void F1059_10342 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1058, Current, 0, 0, 3554);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1058, Current, 3554);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9641, 0xF8000422, 0); /* right */
