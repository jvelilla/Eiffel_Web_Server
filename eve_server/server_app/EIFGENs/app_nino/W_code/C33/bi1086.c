...
extern EIF_TYPED_VALUE F1086_10350(EIF_REFERENCE);
extern void F1086_10353(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1086_23500(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F1086_10350 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1085, Current, 0, 0, 3765);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1085, Current, 3765);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F1086_10353 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 1085, Current, 0, 1, 3766);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1085, Current, 3766);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9801, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	uu2_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9803, dtype))(Current, uu2_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F1086_23500 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1085, Current, 0, 23499);
	RTSA(dtype);
	RTME(dtype, 0);
