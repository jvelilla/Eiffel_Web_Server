...
extern void F1080_11388(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1080_11389(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1080_11390(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1080_11391(EIF_REFERENCE);
extern void F1080_22890(EIF_REFERENCE, int);
...
void F1080_11388 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 1079, Current, 0, 3, 4296);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1079, Current, 4296);
	RTCC(arg1, 1079, l_feature_name, 1, RTWCT(10603, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10603, 0xF8000436, 0); /* active */
...
EIF_TYPED_VALUE F1080_11389 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1080_11390 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F1080_11391 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1080_22890 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1079, Current, 0, 22889);
	RTSA(dtype);
	RTME(dtype, 0);
