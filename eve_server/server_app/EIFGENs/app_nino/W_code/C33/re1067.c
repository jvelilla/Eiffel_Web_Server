...
extern EIF_TYPED_VALUE F1067_12810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1067_12810 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1066, Current, 0, 0, 5980);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1066, Current, 5980);
	RTIV(Current, RTAL);
	RTHOOK(1);
