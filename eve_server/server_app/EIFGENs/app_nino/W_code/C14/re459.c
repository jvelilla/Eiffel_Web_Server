...
extern EIF_TYPED_VALUE F459_12182(EIF_REFERENCE);
...
EIF_TYPED_VALUE F459_12182 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 458, Current, 0, 0, 5405);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 5405);
	RTIV(Current, RTAL);
	RTHOOK(1);
