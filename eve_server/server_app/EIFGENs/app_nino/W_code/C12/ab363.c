...
extern EIF_TYPED_VALUE F363_18695(EIF_REFERENCE);
...
EIF_TYPED_VALUE F363_18695 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 362, Current, 0, 0, 12255);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(362, Current, 12255);
	RTIV(Current, RTAL);
	RTHOOK(1);
