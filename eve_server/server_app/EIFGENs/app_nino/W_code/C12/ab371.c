...
extern EIF_TYPED_VALUE F371_18819(EIF_REFERENCE);
...
EIF_TYPED_VALUE F371_18819 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 370, Current, 0, 0, 12391);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(370, Current, 12391);
	RTIV(Current, RTAL);
	RTHOOK(1);
