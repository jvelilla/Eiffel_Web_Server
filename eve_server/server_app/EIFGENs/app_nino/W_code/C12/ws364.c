...
extern EIF_TYPED_VALUE F364_18749(EIF_REFERENCE);
extern EIF_TYPED_VALUE F364_18752(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F364_18749 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 363, Current, 0, 0, 13006);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(363, Current, 13006);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16530, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F364_18752 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 363, Current, 0, 1, 13007);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(363, Current, 13007);
	if (arg1) {
		RTCC(arg1, 363, l_feature_name, 1, 357);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16297, "percent_encoded_path_info", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
