...
extern EIF_TYPED_VALUE F376_18882(EIF_REFERENCE);
...
EIF_TYPED_VALUE F376_18882 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 375, Current, 0, 0, 12464);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(375, Current, 12464);
	RTIV(Current, RTAL);
	RTHOOK(1);
