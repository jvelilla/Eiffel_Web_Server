...
extern EIF_TYPED_VALUE F372_18873(EIF_REFERENCE);
extern EIF_TYPED_VALUE F372_18876(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F372_18873 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 371, Current, 0, 0, 13142);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(371, Current, 13142);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F372_18876 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 371, Current, 0, 1, 13143);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(371, Current, 13143);
	if (arg1) {
		RTCC(arg1, 371, l_feature_name, 1, 365);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16418, "percent_encoded_path_info", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
