...
extern void F379_18896(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {JSON_NULL}.accept */
void F379_18896 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 378, Current, 0, 1, 13139);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 378, l_feature_name, 1, 18);
	}
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3818, "visit_json_null", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
#define up1 up1x.it_p
	...
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16622, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
{
	GTCX
	RTOTC (F379_18898,13142,RTMS_EX_H("null",4,1853189228));
}

void EIF_Minit379 (void)
{
	GTCX
	RTOTS (18898,F379_18898)
}
