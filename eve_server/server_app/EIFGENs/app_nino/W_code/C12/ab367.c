...
extern EIF_TYPED_VALUE F367_18756(EIF_REFERENCE);
...
EIF_TYPED_VALUE F367_18756 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 366, Current, 0, 0, 12338);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(366, Current, 12338);
	RTIV(Current, RTAL);
	RTHOOK(1);
