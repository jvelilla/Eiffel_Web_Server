...
extern EIF_TYPED_VALUE F48_867(EIF_REFERENCE);
...
EIF_TYPED_VALUE F48_866 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 47, Current, 0, 0, 951);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(506, 22))(Current)).it_i4);
...
RTOID (F48_867)
EIF_TYPED_VALUE F48_867 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 47, Current, 0, 0, 952);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
