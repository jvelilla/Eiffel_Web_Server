...
extern void F51_890(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F51_887 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 50, Current, 0, 0, 972);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(50, Current, 972);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 50, Current, 0, 0, 974);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(50, Current, 974);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F51_890 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 50, Current, 0, 1, 975);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
