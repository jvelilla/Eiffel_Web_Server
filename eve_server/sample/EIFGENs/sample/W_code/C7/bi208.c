...
extern EIF_TYPED_VALUE F208_1103(EIF_REFERENCE);
extern void F208_1106(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F208_4563(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F208_1103 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 207, Current, 0, 0, 1433);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(207, Current, 1433);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}._invariant */
void F208_4563 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 207, Current, 0, 4562);
	RTSA(dtype);
	RTME(dtype, 0);
