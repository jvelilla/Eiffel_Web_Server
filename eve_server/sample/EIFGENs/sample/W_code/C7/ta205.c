...
extern void F205_1146(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F205_1146 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 204, Current, 0, 1, 1628);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(204, Current, 1628);
	RTCC(arg1, 204, l_feature_name, 1, RTWCT(976, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
