...
extern EIF_TYPED_VALUE F199_1116(EIF_REFERENCE);
extern void F199_4566(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F199_1116 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 198, Current, 0, 0, 1495);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(198, Current, 1495);
	RTIV(Current, RTAL);
	RTHOOK(1);
