...
extern void F13_4554(EIF_REFERENCE, int);
...
#define arg1 arg1x.it_r8
	...
	RTEAA(l_feature_name, 12, Current, 0, 1, 478);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(12, Current, 478);
	RTIV(Current, RTAL);
...
#define arg1 arg1x.it_r8
	...
	RTEAA(l_feature_name, 12, Current, 0, 1, 481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(12, Current, 481);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("amt_positive", EX_PRE);
...
/* {ACCOUNT}._invariant */
void F13_4554 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 12, Current, 0, 4553);
	RTSA(dtype);
	RTME(dtype, 0);
