...
extern EIF_TYPED_VALUE F544_1116(EIF_REFERENCE);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F544_1116 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 543, Current, 0, 0, 1513);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(543, Current, 1513);
	RTIV(Current, RTAL);
	RTHOOK(1);
