...
extern EIF_TYPED_VALUE F164_3922(EIF_REFERENCE);
extern void F164_4595(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F164_3922 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F164_4595 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 163, Current, 0, 4594);
	RTSA(dtype);
	RTME(dtype, 0);
