...
extern EIF_TYPED_VALUE F269_1116(EIF_REFERENCE);
extern void F269_4566(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F269_1116 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 268, Current, 0, 0, 1499);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(268, Current, 1499);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F269_4566 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 268, Current, 0, 4565);
	RTSA(dtype);
	RTME(dtype, 0);
