...
extern EIF_TYPED_VALUE F264_1074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F264_1075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F264_1076(EIF_REFERENCE);
extern void F264_1077(EIF_REFERENCE);
extern void F264_1078(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F264_1074 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 263, Current, 0, 0, 1166);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(263, Current, 1166);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F264_1075 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F264_1076 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 263, Current, 0, 0, 1168);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(263, Current, 1168);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F264_1077 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 263, Current, 0, 0, 1169);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(263, Current, 1169);
	RTIV(Current, RTAL);
...
void F264_1078 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 263, Current, 0, 0, 1170);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(263, Current, 1170);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
