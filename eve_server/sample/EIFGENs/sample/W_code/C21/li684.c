...
extern EIF_TYPED_VALUE F684_2227(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F684_2228(EIF_REFERENCE);
extern EIF_TYPED_VALUE F684_2229(EIF_REFERENCE);
extern void F684_4583(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F684_2227 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 683, Current, 2, 1, 4684);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(683, Current, 4684);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1024, "item", arg1))(arg1)).it_r4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F684_2228 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 683, Current, 0, 0, 4685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(683, Current, 4685);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F684_2229 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 683, Current, 0, 0, 4686);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(683, Current, 4686);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F684_4583 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 683, Current, 0, 4582);
	RTSA(dtype);
	RTME(dtype, 0);
