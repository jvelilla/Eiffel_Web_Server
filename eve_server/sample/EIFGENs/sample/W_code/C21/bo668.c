...
extern EIF_TYPED_VALUE F668_1116(EIF_REFERENCE);
extern void F668_4566(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F668_1116 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 667, Current, 0, 0, 1517);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(667, Current, 1517);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F668_4566 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 667, Current, 0, 4565);
	RTSA(dtype);
	RTME(dtype, 0);
