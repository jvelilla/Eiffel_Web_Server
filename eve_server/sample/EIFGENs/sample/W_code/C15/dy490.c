...
extern EIF_TYPED_VALUE F490_2213(EIF_REFERENCE);
extern EIF_TYPED_VALUE F490_2214(EIF_REFERENCE);
extern void F490_2220(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F490_2223(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F490_2224(EIF_REFERENCE);
extern EIF_TYPED_VALUE F490_2225(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F490_2213 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 489, Current, 0, 0, 4609);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(489, Current, 4609);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F490_2214 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 489, Current, 0, 0, 4610);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(489, Current, 4610);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F490_2220 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 489, Current, 0, 1, 4611);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(489, Current, 4611);
	RTIV(Current, RTAL);
...
void F490_2223 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 489, Current, 0, 1, 4612);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(489, Current, 4612);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F490_2224 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 489, Current, 0, 0, 4613);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(489, Current, 4613);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F490_2225 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 489, Current, 2, 1, 4614);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(489, Current, 4614);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uc1 = tc1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1011, "extend", Result))(Result, uc1x);
		RTHOOK(9);
