...
extern void F386_1317(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F386_1318(EIF_REFERENCE);
extern EIF_TYPED_VALUE F386_1319(EIF_REFERENCE);
extern EIF_TYPED_VALUE F386_1320(EIF_REFERENCE);
extern void F386_4571(EIF_REFERENCE, int);
...
void F386_1317 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 385, Current, 0, 3, 1844);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(385, Current, 1844);
	RTCC(arg1, 385, l_feature_name, 1, RTWCT(1165, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1165, 0xF800017E, 0); /* active */
...
EIF_TYPED_VALUE F386_1318 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F386_1319 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F386_1320 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F386_4571 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 385, Current, 0, 4570);
	RTSA(dtype);
	RTME(dtype, 0);
