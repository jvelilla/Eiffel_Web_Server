...
extern void F116_2286(EIF_REFERENCE);
extern EIF_TYPED_VALUE F116_2287(EIF_REFERENCE);
...
void F116_2286 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 115, Current, 2, 0, 4827);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(115, Current, 4827);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F116_2287)
EIF_TYPED_VALUE F116_2287 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 115, Current, 0, 0, 4828);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
