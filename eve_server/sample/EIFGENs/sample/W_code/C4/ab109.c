...
extern EIF_TYPED_VALUE F109_1922(EIF_REFERENCE);
...
EIF_TYPED_VALUE F109_1922 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 108, Current, 0, 0, 2514);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(108, Current, 2514);
	RTIV(Current, RTAL);
	RTHOOK(1);
