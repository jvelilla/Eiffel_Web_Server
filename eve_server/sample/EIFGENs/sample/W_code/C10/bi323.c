...
extern EIF_TYPED_VALUE F323_1103(EIF_REFERENCE);
extern void F323_1106(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F323_4563(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F323_1103 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 322, Current, 0, 0, 1442);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(322, Current, 1442);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F323_1106 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 322, Current, 0, 1, 1443);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(322, Current, 1443);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(993, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	ur8_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(995, dtype))(Current, ur8_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
