...
extern EIF_TYPED_VALUE F304_1074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F304_1075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F304_1076(EIF_REFERENCE);
extern void F304_1077(EIF_REFERENCE);
extern void F304_1078(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F304_1074 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 303, Current, 0, 0, 1176);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(303, Current, 1176);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F304_1075 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F304_1076 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 303, Current, 0, 0, 1178);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(303, Current, 1178);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F304_1077 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 303, Current, 0, 0, 1179);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(303, Current, 1179);
	RTIV(Current, RTAL);
...
void F304_1078 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 303, Current, 0, 0, 1180);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(303, Current, 1180);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
