...
extern EIF_TYPED_VALUE F350_1116(EIF_REFERENCE);
extern void F350_4566(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F350_1116 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 349, Current, 0, 0, 1503);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(349, Current, 1503);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F350_4566 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 349, Current, 0, 4565);
	RTSA(dtype);
	RTME(dtype, 0);
