...
extern EIF_TYPED_VALUE F506_2227(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F506_2228(EIF_REFERENCE);
extern EIF_TYPED_VALUE F506_2229(EIF_REFERENCE);
extern void F506_4583(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F506_2227 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 505, Current, 2, 1, 4672);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(505, Current, 4672);
	RTCC(arg1, 505, l_feature_name, 1, eif_attached_type(Dftype(Current)));
	RTIV(Current, RTAL);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tw2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1024, "item", arg1))(arg1)).it_c4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F506_2228 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 505, Current, 0, 0, 4673);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(505, Current, 4673);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F506_2229 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 505, Current, 0, 0, 4674);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(505, Current, 4674);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F506_4583 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 505, Current, 0, 4582);
	RTSA(dtype);
	RTME(dtype, 0);
