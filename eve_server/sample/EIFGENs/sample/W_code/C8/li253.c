...
extern EIF_TYPED_VALUE F253_2227(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F253_2228(EIF_REFERENCE);
extern EIF_TYPED_VALUE F253_2229(EIF_REFERENCE);
extern void F253_4583(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F253_2227 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 252, Current, 2, 1, 4644);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(252, Current, 4644);
...
/* {LIST}.after */
EIF_TYPED_VALUE F253_2228 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 252, Current, 0, 0, 4645);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(252, Current, 4645);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F253_2229 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 252, Current, 0, 0, 4646);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(252, Current, 4646);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F253_4583 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 252, Current, 0, 4582);
	RTSA(dtype);
	RTME(dtype, 0);
