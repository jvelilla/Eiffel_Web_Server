...
extern EIF_TYPED_VALUE F232_1074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F232_1075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F232_1076(EIF_REFERENCE);
extern void F232_1077(EIF_REFERENCE);
extern void F232_1078(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F232_1074 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 231, Current, 0, 0, 1161);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(231, Current, 1161);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F232_1075 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F232_1076 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 231, Current, 0, 0, 1163);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(231, Current, 1163);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F232_1077 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 231, Current, 0, 0, 1164);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(231, Current, 1164);
	RTIV(Current, RTAL);
...
void F232_1078 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 231, Current, 0, 0, 1165);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(231, Current, 1165);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
