...
extern EIF_TYPED_VALUE F255_2213(EIF_REFERENCE);
extern EIF_TYPED_VALUE F255_2214(EIF_REFERENCE);
extern void F255_2220(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F255_2223(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F255_2224(EIF_REFERENCE);
extern EIF_TYPED_VALUE F255_2225(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F255_2213 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 4573);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(254, Current, 4573);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F255_2214 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 4574);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(254, Current, 4574);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F255_2220 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 254, Current, 0, 1, 4575);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 4575);
	RTIV(Current, RTAL);
...
void F255_2223 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 254, Current, 0, 1, 4576);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 4576);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F255_2224 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 254, Current, 0, 0, 4577);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 4577);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F255_2225 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 254, Current, 2, 1, 4578);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(254, Current, 4578);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
