...
extern EIF_TYPED_VALUE F225_1075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F225_1076(EIF_REFERENCE);
extern EIF_TYPED_VALUE F225_1077(EIF_REFERENCE);
extern void F225_1078(EIF_REFERENCE);
extern void F225_1079(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F225_1075 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 224, Current, 0, 0, 1162);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(224, Current, 1162);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F225_1076 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F225_1077 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 224, Current, 0, 0, 1164);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(224, Current, 1164);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F225_1078 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 224, Current, 0, 0, 1165);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(224, Current, 1165);
	RTIV(Current, RTAL);
...
void F225_1079 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 224, Current, 0, 0, 1166);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(224, Current, 1166);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
