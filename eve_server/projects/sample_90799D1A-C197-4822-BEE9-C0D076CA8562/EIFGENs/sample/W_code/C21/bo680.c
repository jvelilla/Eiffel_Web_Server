...
extern EIF_TYPED_VALUE F680_1117(EIF_REFERENCE);
extern void F680_4567(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F680_1117 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 679, Current, 0, 0, 1518);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(679, Current, 1518);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F680_4567 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 679, Current, 0, 4566);
	RTSA(dtype);
	RTME(dtype, 0);
