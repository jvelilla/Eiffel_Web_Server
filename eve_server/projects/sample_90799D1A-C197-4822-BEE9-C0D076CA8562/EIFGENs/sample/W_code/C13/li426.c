...
extern EIF_TYPED_VALUE F426_2018(EIF_REFERENCE);
extern EIF_TYPED_VALUE F426_2019(EIF_REFERENCE);
extern void F426_2020(EIF_REFERENCE);
extern void F426_2021(EIF_REFERENCE);
extern EIF_TYPED_VALUE F426_2022(EIF_REFERENCE);
extern EIF_TYPED_VALUE F426_2023(EIF_REFERENCE);
...
EIF_TYPED_VALUE F426_2018 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 425, Current, 1, 0, 2882);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(425, Current, 2882);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		...
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1174, 223))(Current)).it_i4);
	} else {
		RTHOOK(4);
...
EIF_TYPED_VALUE F426_2019 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 425, Current, 0, 0, 2883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(425, Current, 2883);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(1703, dtype));
	if (tb1) {
		...
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1175, 223))(Current)).it_b);
	} else {
		RTHOOK(3);
		RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F426_2020 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 425, Current, 0, 0, 2884);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(425, Current, 2884);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(1709, 223))(Current);
	RTHOOK(2);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(1703, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 1712, 0xF80001A7, 0); /* active */
...
void F426_2021 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 425, Current, 2, 0, 2885);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(425, Current, 2885);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
body:;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(1176, 223))(Current);
	RTHOOK(3);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(1703, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F426_2022 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F426_2023 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
