...
extern EIF_TYPED_VALUE F439_1075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F439_1076(EIF_REFERENCE);
extern EIF_TYPED_VALUE F439_1077(EIF_REFERENCE);
extern void F439_1078(EIF_REFERENCE);
extern void F439_1079(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F439_1075 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 438, Current, 0, 0, 1197);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(438, Current, 1197);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F439_1076 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F439_1077 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 438, Current, 0, 0, 1199);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(438, Current, 1199);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F439_1078 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 438, Current, 0, 0, 1200);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(438, Current, 1200);
	RTIV(Current, RTAL);
...
void F439_1079 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 438, Current, 0, 0, 1201);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(438, Current, 1201);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
