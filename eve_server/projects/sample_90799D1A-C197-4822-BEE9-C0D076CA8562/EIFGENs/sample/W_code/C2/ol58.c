...
extern EIF_TYPED_VALUE F58_903(EIF_REFERENCE);
...
/* {OLD_VIOLATION}.tag */
RTOID (F58_903)
EIF_TYPED_VALUE F58_903 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 57, Current, 0, 0, 988);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(57, Current, 988);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
