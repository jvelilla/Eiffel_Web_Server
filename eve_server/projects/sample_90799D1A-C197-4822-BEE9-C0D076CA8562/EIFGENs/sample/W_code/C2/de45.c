...
extern EIF_TYPED_VALUE F45_865(EIF_REFERENCE);
extern EIF_TYPED_VALUE F45_866(EIF_REFERENCE);
...
EIF_TYPED_VALUE F45_865 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 44, Current, 0, 0, 950);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(525, 22))(Current)).it_i4);
...
RTOID (F45_866)
EIF_TYPED_VALUE F45_866 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 44, Current, 0, 0, 951);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
