...
extern EIF_TYPED_VALUE F71_931(EIF_REFERENCE);
extern void F71_932(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F71_933(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F71_929 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(854,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F71_930 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 70, Current, 0, 0, 1013);
	RTSA(Dtype(Current));
	RTSC;
...
/* {ROUTINE_FAILURE}.tag */
RTOID (F71_931)
EIF_TYPED_VALUE F71_931 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 70, Current, 0, 0, 1014);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 70, Current, 0, 1, 1015);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(70, Current, 1015);
	RTCC(arg1, 70, l_feature_name, 1, RTWCT(853, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 853, 0xF80000AA, 0); /* routine_name */
...
void F71_933 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 70, Current, 0, 1, 1016);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(70, Current, 1016);
	RTCC(arg1, 70, l_feature_name, 1, RTWCT(854, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 854, 0xF80000AA, 0); /* class_name */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(854, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("class_name_set", EX_POST);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(854, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		if (RTCEQ(tr1, arg1)) {
			RTCK;
		} else {
			RTCF;
