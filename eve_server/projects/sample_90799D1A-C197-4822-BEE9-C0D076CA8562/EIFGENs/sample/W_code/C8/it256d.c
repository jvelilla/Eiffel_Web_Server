...
static EIF_TYPE_INDEX gen_type1_256 [] = {0xFF11,180,0xFF12,255,160,0xFFFF};
static EIF_TYPE_INDEX gen_type2_256 [] = {0xFF11,255,160,0xFFFF};
static EIF_TYPE_INDEX gen_type3_256 [] = {0,0xFFFF};
static EIF_TYPE_INDEX gen_type4_256 [] = {0,0xFFFF};
static EIF_TYPE_INDEX gen_type5_256 [] = {0xFF11,255,160,0xFFFF};
static EIF_TYPE_INDEX gen_type6_256 [] = {0xFF11,255,160,0xFFFF};
...
static EIF_TYPE_INDEX gen_type12_256 [] = {255,160,0xFFFF};
static EIF_TYPE_INDEX gen_type13_256 [] = {0xFF11,255,160,0xFFFF};
static EIF_TYPE_INDEX gen_type14_256 [] = {0xFFF8,1,0xFFFF};
...
static struct desc_info desc_256[] = {
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, (EIF_TYPE_INDEX)-1, gen_type14_256},
