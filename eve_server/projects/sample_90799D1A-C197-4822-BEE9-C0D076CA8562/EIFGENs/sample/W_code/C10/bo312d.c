...
static EIF_TYPE_INDEX gen_type1_312 [] = {0xFF11,180,0xFF12,311,148,0xFFFF};
static EIF_TYPE_INDEX gen_type2_312 [] = {0xFF11,311,148,0xFFFF};
static EIF_TYPE_INDEX gen_type3_312 [] = {0,0xFFFF};
static EIF_TYPE_INDEX gen_type4_312 [] = {0,0xFFFF};
static EIF_TYPE_INDEX gen_type5_312 [] = {0xFF11,311,148,0xFFFF};
static EIF_TYPE_INDEX gen_type6_312 [] = {0xFF11,311,148,0xFFFF};
...
static EIF_TYPE_INDEX gen_type12_312 [] = {311,148,0xFFFF};
static EIF_TYPE_INDEX gen_type13_312 [] = {0xFF11,311,148,0xFFFF};
static EIF_TYPE_INDEX gen_type14_312 [] = {0xFF11,302,0xFFF8,1,0xFFFF};
...
static struct desc_info desc_312[] = {
	...
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 302, gen_type14_312},
...
void Init312(void)
{
	...
	IDSC(desc_312 + 34, 187, 311);
	IDSC(desc_312 + 43, 210, 311);
}
